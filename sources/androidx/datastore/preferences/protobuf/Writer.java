...
interface Writer {
    ...
    @Deprecated
    void J(int i10, List<?> list, y0 y0Var) throws IOException;

    void K(int i10, ByteString byteString) throws IOException;

    void L(int i10, Object obj, y0 y0Var) throws IOException;

    <K, V> void M(int i10, e0.a<K, V> aVar, Map<K, V> map) throws IOException;

    @Deprecated
    void N(int i10, Object obj, y0 y0Var) throws IOException;

    void O(int i10, List<?> list, y0 y0Var) throws IOException;
