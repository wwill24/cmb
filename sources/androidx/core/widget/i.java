...
public class i extends a {
    ...
    private final ListView f4955y;

    public i(@NonNull ListView listView) {
        super(listView);
        this.f4955y = listView;
    }
    ...
    public boolean b(int r8) {
        /*
            r7 = this;
            android.widget.ListView r0 = r7.f4955y
            int r1 = r0.getCount()
            r2 = 0
        ...
        L_0x0039:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.i.b(int):boolean");
    }
