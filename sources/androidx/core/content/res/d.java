...
public final class d {
    ...
    private final Shader f4544a;

    /* renamed from: b  reason: collision with root package name */
    private final ColorStateList f4545b;
    ...
    private static androidx.core.content.res.d a(@androidx.annotation.NonNull android.content.res.Resources r4, int r5, android.content.res.Resources.Theme r6) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        /*
    ...
    public static d g(@NonNull Resources resources, int i10, Resources.Theme theme) {
        try {
    ...
    public boolean i() {
        /*
            r1 = this;
            android.graphics.Shader r0 = r1.f4544a
            if (r0 != 0) goto L_0x0010
            android.content.res.ColorStateList r0 = r1.f4545b
            if (r0 == 0) goto L_0x0010
    ...
    public boolean j(int[] iArr) {
        if (i()) {
            ColorStateList colorStateList = this.f4545b;
            int colorForState = colorStateList.getColorForState(iArr, colorStateList.getDefaultColor());
            if (colorForState != this.f4546c) {
                this.f4546c = colorForState;
                return true;
            }
        }
        return false;
