...
public final class c {
    ...
    private static final ThreadLocal<TypedValue> f4543a = new ThreadLocal<>();

    /* JADX WARNING: Removed duplicated region for block: B:6:0x0011  */
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0016  */
    @androidx.annotation.NonNull
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.content.res.ColorStateList a(@androidx.annotation.NonNull android.content.res.Resources r4, @androidx.annotation.NonNull org.xmlpull.v1.XmlPullParser r5, android.content.res.Resources.Theme r6) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    private static TypedValue c() {
        ThreadLocal<TypedValue> threadLocal = f4543a;
    ...
    public static ColorStateList d(@NonNull Resources resources, int i10, Resources.Theme theme) {
        try {
    ...
    private static android.content.res.ColorStateList e(@androidx.annotation.NonNull android.content.res.Resources r17, @androidx.annotation.NonNull org.xmlpull.v1.XmlPullParser r18, @androidx.annotation.NonNull android.util.AttributeSet r19, android.content.res.Resources.Theme r20) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0022:
            ...
            goto L_0x00e7
        L_0x0035:
            int[] r9 = t0.d.ColorStateListItem
            android.content.res.TypedArray r9 = h(r0, r2, r1, r9)
            int r10 = t0.d.ColorStateListItem_android_color
            r11 = -1
        ...
        L_0x0065:
            ...
            int r12 = t0.d.ColorStateListItem_android_alpha
            boolean r13 = r9.hasValue(r12)
            if (r13 == 0) goto L_0x0074
            float r11 = r9.getFloat(r12, r11)
            goto L_0x0080
        L_0x0074:
            int r12 = t0.d.ColorStateListItem_alpha
            boolean r13 = r9.hasValue(r12)
        ...
        L_0x0080:
            ...
            int r12 = t0.d.ColorStateListItem_android_lStar
            boolean r13 = r9.hasValue(r12)
            if (r13 == 0) goto L_0x0095
            float r12 = r9.getFloat(r12, r14)
            goto L_0x009b
        L_0x0095:
            int r12 = t0.d.ColorStateListItem_lStar
            float r12 = r9.getFloat(r12, r14)
        L_0x009b:
            r9.recycle()
    ...
    private static boolean f(@NonNull Resources resources, int i10) {
        TypedValue c10 = c();
