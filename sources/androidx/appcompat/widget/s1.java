...
public class s1 extends x0 {
    ...
    private static boolean f1441c = false;

    /* renamed from: b  reason: collision with root package name */
    private final WeakReference<Context> f1442b;

    public s1(@NonNull Context context, @NonNull Resources resources) {
        super(resources);
        this.f1442b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) throws Resources.NotFoundException {
        ...
        if (context != null) {
            return w0.g().s(context, this, i10);
        }
        return a(i10);
    }
