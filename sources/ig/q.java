...
class q {
    static byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr3.length == 32) {
            ...
            long j50 = (j41 | (j35 & j46) | (j47 << 26)) & UInt32.MAX_VALUE_LONG;
            long j51 = ((j47 >> 6) | (j48 << 20)) & UInt32.MAX_VALUE_LONG;
            long j52 = ((j48 >> 12) | (j49 << 14)) & UInt32.MAX_VALUE_LONG;
            long j53 = ((j49 >> 18) | (((j39 & j46) | j45) << 8)) & UInt32.MAX_VALUE_LONG;
            long d10 = j50 + d(bArr3, 16);
            long j54 = d10 & UInt32.MAX_VALUE_LONG;
            long d11 = j51 + d(bArr3, 20) + (d10 >> 32);
            long j55 = d11 & UInt32.MAX_VALUE_LONG;
            long d12 = j52 + d(bArr3, 24) + (d11 >> 32);
            long j56 = d12 & UInt32.MAX_VALUE_LONG;
            long d13 = (j53 + d(bArr3, 28) + (d12 >> 32)) & UInt32.MAX_VALUE_LONG;
    ...
    private static long d(byte[] bArr, int i10) {
        return ((long) (((bArr[i10 + 3] & 255) << 24) | (bArr[i10] & 255) | ((bArr[i10 + 1] & 255) << 8) | ((bArr[i10 + 2] & 255) << Tnaf.POW_2_WIDTH))) & UInt32.MAX_VALUE_LONG;
    }
    ...
    static void f(byte[] bArr, byte[] bArr2, byte[] bArr3) throws GeneralSecurityException {
