...
public class ShareInviteHelper {
    public static LinkGenerator generateInviteUrl(Context context) {
        ...
        AFb1zSDK aFb1zSDK = (AFb1zSDK) instance;
        LinkGenerator addParameter = new LinkGenerator("af_app_invites").setBaseURL(string, string2, context.getPackageName()).setReferrerUID(appsFlyerUID).setReferrerCustomerId(AFb1zSDK.AFKeystoreWrapper()).addParameter("af_siteid", context.getPackageName());
