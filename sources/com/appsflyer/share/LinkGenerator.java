...
public class LinkGenerator {
    ...
    private Map<String, String> AFInAppEventType() {
        ...
        if (this.getLevel != null) {
            ...
            if (str7 != null) {
                ...
                if (!this.getLevel.endsWith(RemoteSettings.FORWARD_SLASH_STRING)) {
    ...
    public String generateLink() {
        ...
        if (str == null || !str.startsWith("http")) {
            sb2.append(String.format(AFf1lSDK.values, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1zSDK.AFInAppEventType().getHostName()}));
        } else {
        ...
        Map<String, String> AFInAppEventType2 = AFInAppEventType();
        StringBuilder sb3 = new StringBuilder();
        for (Map.Entry next : AFInAppEventType2.entrySet()) {
            if (sb3.length() == 0) {
                sb3.append('?');
            } else {
                sb3.append('&');
    ...
    public LinkGenerator setBaseURL(String str, String str2, String str3) {
        if (str == null || str.length() <= 0) {
            this.values = String.format("https://%s/%s", new Object[]{String.format("%sapp.%s", new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1zSDK.AFInAppEventType().getHostName()}), str3});
        } else {
            if (str2 == null || str2.length() < 5) {
                str2 = "go.onelink.me";
            }
            this.values = String.format("https://%s/%s", new Object[]{str2, str});
        }
        return this;
    }
    ...
    public void generateLink(Context context, ResponseListener responseListener) {
        ...
        AFd1oSDK aFd1oSDK = new AFd1oSDK(AFInAppEventParameterName2, UUID.randomUUID(), string, AFInAppEventType2, str, responseListener);
        AFd1xSDK afDebugLog2 = AFInAppEventParameterName2.afDebugLog();
        afDebugLog2.AFKeystoreWrapper.execute(new Runnable(aFd1oSDK) {
