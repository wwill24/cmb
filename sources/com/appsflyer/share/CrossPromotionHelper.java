...
public class CrossPromotionHelper {
    ...
    private static void valueOf(@NonNull String str, @NonNull Context context, AFe1tSDK aFe1tSDK) {
        ...
        afDebugLog.AFKeystoreWrapper.execute(new Runnable(aFd1sSDK) {
...
*/
    ...
    public static void logAndOpenStore(@NonNull Context context, String str, String str2, Map<String, String> map) {
        LinkGenerator valueOf = valueOf(context, str, str2, map, String.format(AFf1lSDK.values, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1zSDK.AFInAppEventType().getHostName()}));
    ...
    public static void logCrossPromoteImpression(@NonNull Context context, String str, String str2, Map<String, String> map) {
        if (AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.AF_WAITFOR_CUSTOMERID, false)) {
            ...
            valueOf(valueOf(context, str, str2, map, String.format(values, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1zSDK.AFInAppEventType().getHostName()})).generateLink(), context, (AFe1tSDK) null);
        }
    }
