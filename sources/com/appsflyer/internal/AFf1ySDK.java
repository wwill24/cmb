...
public class AFf1ySDK extends AFf1zSDK {
    ...
    public AFf1ySDK(Runnable runnable) {
        super(StoreHint.ELEMENT, "google", runnable);
    }
            ...
            try {
                ...
                build.startConnection(new InstallReferrerStateListener() {
                    ...
                    public final void onInstallReferrerSetupFinished(int i10) {
                        AFf1ySDK.this.AFInAppEventParameterName.put("code", String.valueOf(i10));
                        ...
                        if (i10 == -1) {
                            ...
                            AFf1ySDK.this.values.put("response", MessageTemplateConstants.Values.OK_TEXT);
                            try {
                                ...
                                AFf1ySDK.this.AFInAppEventParameterName.put("err", th2.getMessage());
