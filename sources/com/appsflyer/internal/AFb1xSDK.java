...
public final class AFb1xSDK {
    ...
    public static synchronized String AFInAppEventParameterName(WeakReference<Context> weakReference) {
        synchronized (AFb1xSDK.class) {
            ...
            if (values == null) {
                String str2 = null;
                if (weakReference.get() != null) {
                    str2 = AFb1zSDK.AFInAppEventType(weakReference.get()).getString("AF_INSTALLATION", (String) null);
                }
                if (str2 != null) {
                    values = str2;
                } else {
                    try {
                        ...
                        String str3 = values;
                        SharedPreferences.Editor edit = AFb1zSDK.AFInAppEventType(weakReference.get()).edit();
    ...
    private static java.lang.String AFKeystoreWrapper(java.io.File r6) {
        ...
        L_0x0052:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.AFb1xSDK.AFKeystoreWrapper(java.io.File):java.lang.String");
    }
}
