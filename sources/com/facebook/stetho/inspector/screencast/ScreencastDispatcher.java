            ...
            if (ScreencastDispatcher.this.mIsRunning && (tryGetTopActivity = ScreencastDispatcher.this.mActivityTracker.tryGetTopActivity()) != null) {
                ...
                try {
                    if (ScreencastDispatcher.this.mBitmap == null) {
                        ...
                        float min = Math.min(((float) ScreencastDispatcher.this.mRequest.maxWidth) / f10, ((float) ScreencastDispatcher.this.mRequest.maxHeight) / height);
                        int i10 = (int) (f10 * min);
                        int i11 = (int) (min * height);
                        Bitmap unused = ScreencastDispatcher.this.mBitmap = Bitmap.createBitmap(i10, i11, Bitmap.Config.RGB_565);
                        Canvas unused2 = ScreencastDispatcher.this.mCanvas = new Canvas(ScreencastDispatcher.this.mBitmap);
                        Matrix matrix = new Matrix();
                        ScreencastDispatcher.this.mTempSrc.set(0.0f, 0.0f, f10, height);
                        ScreencastDispatcher.this.mTempDst.set(0.0f, 0.0f, (float) i10, (float) i11);
    ...
    private class EventDispatchRunnable implements Runnable {
        ...
        public void run() {
            if (ScreencastDispatcher.this.mIsRunning && ScreencastDispatcher.this.mBitmap != null) {
                ...
                ScreencastDispatcher.this.mBitmap.compress(Bitmap.CompressFormat.valueOf(ScreencastDispatcher.this.mRequest.f37942format.toUpperCase()), ScreencastDispatcher.this.mRequest.quality, base64OutputStream);
