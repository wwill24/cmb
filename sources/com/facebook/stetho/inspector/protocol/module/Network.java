...
public class Network implements ChromeDevtoolsDomain {
    ...
    private GetResponseBodyResponse readResponseBody(String str) throws IOException, JsonRpcException {
        ...
        try {
            ...
            throw new JsonRpcException(new JsonRpcError(JsonRpcError.ErrorCode.INTERNAL_ERROR, e10.toString(), (b) null));
        }
    }
    ...
    @ChromeDevtoolsMethod
    public JsonRpcResult getResponseBody(JsonRpcPeer jsonRpcPeer, b bVar) throws JsonRpcException {
        try {
            return readResponseBody(bVar.getString("requestId"));
        } catch (IOException e10) {
            throw new JsonRpcException(new JsonRpcError(JsonRpcError.ErrorCode.INTERNAL_ERROR, e10.toString(), (b) null));
        } catch (JSONException e11) {
            throw new JsonRpcException(new JsonRpcError(JsonRpcError.ErrorCode.INTERNAL_ERROR, e11.toString(), (b) null));
        }
    }
    ...
    @ChromeDevtoolsMethod
    public void setUserAgentOverride(JsonRpcPeer jsonRpcPeer, b bVar) {
    }
}
