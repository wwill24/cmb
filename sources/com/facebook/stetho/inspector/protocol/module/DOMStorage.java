...
public class DOMStorage implements ChromeDevtoolsDomain {
    ...
    @ChromeDevtoolsMethod
    public JsonRpcResult getDOMStorageItems(JsonRpcPeer jsonRpcPeer, b bVar) throws JSONException {
        StorageId storageId = (StorageId) this.mObjectMapper.convertValue(bVar.getJSONObject("storageId"), StorageId.class);
        ArrayList arrayList = new ArrayList();
        String str = storageId.securityOrigin;
        if (storageId.isLocalStorage) {
            for (Map.Entry next : SharedPreferencesHelper.getSharedPreferenceEntriesSorted(this.mContext.getSharedPreferences(str, 0))) {
                ArrayList arrayList2 = new ArrayList(2);
                arrayList2.add(next.getKey());
                arrayList2.add(SharedPreferencesHelper.valueToString(next.getValue()));
    ...
    @ChromeDevtoolsMethod
    public void removeDOMStorageItem(JsonRpcPeer jsonRpcPeer, b bVar) throws JSONException {
        StorageId storageId = (StorageId) this.mObjectMapper.convertValue(bVar.getJSONObject("storageId"), StorageId.class);
    ...
    public void setDOMStorageItem(com.facebook.stetho.inspector.jsonrpc.JsonRpcPeer r10, org.json.b r11) throws org.json.JSONException, com.facebook.stetho.inspector.jsonrpc.JsonRpcException {
        /*
            r9 = this;
            com.facebook.stetho.json.ObjectMapper r10 = r9.mObjectMapper
            java.lang.String r0 = "storageId"
            org.json.b r0 = r11.getJSONObject(r0)
        ...
        L_0x00a3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.stetho.inspector.protocol.module.DOMStorage.setDOMStorageItem(com.facebook.stetho.inspector.jsonrpc.JsonRpcPeer, org.json.b):void");
    }
}
