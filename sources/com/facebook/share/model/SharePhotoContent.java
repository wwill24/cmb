...
public final class SharePhotoContent extends ShareContent<SharePhotoContent, Builder> {
    ...
    private SharePhotoContent(Builder builder) {
        super(builder);
        this.photos = CollectionsKt___CollectionsKt.x0(builder.getPhotos$facebook_common_release());
    }
    ...
    public SharePhotoContent(Parcel parcel) {
        super(parcel);
        j.g(parcel, "parcel");
        this.photos = CollectionsKt___CollectionsKt.x0(SharePhoto.Builder.Companion.readPhotoListFrom$facebook_common_release(parcel));
    }
}
