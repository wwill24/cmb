...
public final class d extends b6.c<i, c> {
    ...
    public static final class b {
        ...
        private final ViewGroup f35543a;

        /* renamed from: b  reason: collision with root package name */
        private final f f35544b;

        public b(ViewGroup viewGroup, f fVar) {
            kotlin.jvm.internal.j.g(viewGroup, "NotificationView");
            kotlin.jvm.internal.j.g(fVar, "interactor");
            this.f35543a = viewGroup;
            this.f35544b = fVar;
        }

        public final NotificationPresenter a() {
            return new NotificationPresenter(this.f35543a, this.f35544b);
        }
    }
    ...
    public final i b(ViewGroup viewGroup) {
        ...
        f fVar = new f();
        View inflate = LayoutInflater.from(((c) a()).a()).inflate(R.layout.component_onboarding_notification, viewGroup, false);
