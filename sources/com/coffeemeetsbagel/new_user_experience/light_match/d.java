...
public final class d extends b6.c<i, c> {
    ...
    public static final class b {
        ...
        private final ViewGroup f35118a;

        /* renamed from: b  reason: collision with root package name */
        private final f f35119b;

        public b(ViewGroup viewGroup, f fVar) {
            kotlin.jvm.internal.j.g(viewGroup, "LightMatchView");
            kotlin.jvm.internal.j.g(fVar, "listener");
            this.f35118a = viewGroup;
            this.f35119b = fVar;
        }

        public final LightMatchPresenter a() {
            return new LightMatchPresenter(this.f35118a, this.f35119b);
        }
    }
    ...
    public final i b(ViewGroup viewGroup) {
        ...
        f fVar = new f();
        View inflate = LayoutInflater.from(((c) a()).a()).inflate(R.layout.component_onboarding_light_match, viewGroup, false);
