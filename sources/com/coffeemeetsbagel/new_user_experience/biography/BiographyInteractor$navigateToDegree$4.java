...
final class BiographyInteractor$navigateToDegree$4 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ BiographyInteractor this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BiographyInteractor$navigateToDegree$4(BiographyInteractor biographyInteractor) {
        super(1);
