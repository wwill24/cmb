...
final class BiographyInteractor$onHeight$1$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ BiographyInteractor this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BiographyInteractor$onHeight$1$2(BiographyInteractor biographyInteractor) {
        super(1);
    ...
    public final void a(Throwable th2) {
        ...
        j.f(th2, "error");
        aVar.c(v22, "Failed to save height.", th2);
    }
