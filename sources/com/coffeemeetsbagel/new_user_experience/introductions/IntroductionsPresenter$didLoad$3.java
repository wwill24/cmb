...
final class IntroductionsPresenter$didLoad$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ IntroductionsPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    IntroductionsPresenter$didLoad$3(IntroductionsPresenter introductionsPresenter) {
        super(1);
    ...
    public final void a(String str) {
        ...
        j.f(str, "it");
        y10.r0(StringsKt__StringsKt.W0(str).toString());
    }
