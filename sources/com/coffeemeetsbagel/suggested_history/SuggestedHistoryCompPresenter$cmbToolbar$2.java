...
final class SuggestedHistoryCompPresenter$cmbToolbar$2 extends Lambda implements Function0<CmbToolbar> {
    final /* synthetic */ d<?, ?> $activity;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SuggestedHistoryCompPresenter$cmbToolbar$2(d<?, ?> dVar) {
        super(0);
        this.$activity = dVar;
    }
