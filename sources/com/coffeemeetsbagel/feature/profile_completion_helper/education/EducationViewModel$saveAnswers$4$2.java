...
final class EducationViewModel$saveAnswers$4$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ EducationViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EducationViewModel$saveAnswers$4$2(EducationViewModel educationViewModel) {
        super(0);
    ...
    public final void invoke() {
        ...
        j.f(i10, "tag");
        String apiKey = ProfileQuestion.DEGREE_TWO.getApiKey();
