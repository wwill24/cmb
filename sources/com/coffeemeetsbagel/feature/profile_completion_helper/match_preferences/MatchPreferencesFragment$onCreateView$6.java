...
final class MatchPreferencesFragment$onCreateView$6 extends Lambda implements Function1<QuestionWAnswers, Unit> {
    final /* synthetic */ MatchPreferencesFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MatchPreferencesFragment$onCreateView$6(MatchPreferencesFragment matchPreferencesFragment) {
        super(1);
    ...
    public final void a(QuestionWAnswers questionWAnswers) {
        ...
        matchPreferencesFragment.f1(questionWAnswers);
    }
