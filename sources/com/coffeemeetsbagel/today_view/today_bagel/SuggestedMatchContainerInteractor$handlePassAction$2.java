...
final class SuggestedMatchContainerInteractor$handlePassAction$2 extends Lambda implements Function1<Optional<a>, b0<? extends Optional<SuggestedLimitsEntity>>> {
    final /* synthetic */ SuggestedMatchContainerInteractor this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SuggestedMatchContainerInteractor$handlePassAction$2(SuggestedMatchContainerInteractor suggestedMatchContainerInteractor) {
        super(1);
