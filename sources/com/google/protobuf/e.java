...
final class e {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f21783a     // Catch:{ NoSuchFieldError -> 0x00d8 }
    ...
    static int A(int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) {
        v vVar = (v) jVar;
        int I = I(bArr, i11, bVar);
        vVar.U0(h.b(bVar.f21784a));
        while (I < i12) {
    ...
    static int B(int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) {
        d0 d0Var = (d0) jVar;
        int L = L(bArr, i11, bVar);
        d0Var.i(h.c(bVar.f21785b));
        while (L < i12) {
            int I = I(bArr, L, bVar);
            if (i10 != bVar.f21784a) {
                break;
    ...
    static int C(byte[] bArr, int i10, b bVar) throws InvalidProtocolBufferException {
        ...
        if (i11 < 0) {
            ...
            bVar.f21786c = new String(bArr, I, i11, w.f21953b);
            return I + i11;
        }
    }
    ...
    static int D(int r4, byte[] r5, int r6, int r7, com.google.protobuf.w.j<?> r8, com.google.protobuf.e.b r9) throws com.google.protobuf.InvalidProtocolBufferException {
        /*
            int r6 = I(r5, r6, r9)
            int r0 = r9.f21784a
        ...
        L_0x0010:
            ...
            java.nio.charset.Charset r3 = com.google.protobuf.w.f21953b
            r2.<init>(r5, r6, r0, r3)
            r8.add(r2)
        L_0x001a:
            int r6 = r6 + r0
        ...
        L_0x0045:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.e.D(int, byte[], int, int, com.google.protobuf.w$j, com.google.protobuf.e$b):int");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0042, code lost:
        if (com.google.protobuf.Utf8.t(r6, r7, r2) == false) goto L_0x004f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0044, code lost:
        r9.add(new java.lang.String(r6, r7, r0, com.google.protobuf.w.f21953b));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0053, code lost:
        throw com.google.protobuf.InvalidProtocolBufferException.d();
     */
    ...
    static int E(int r5, byte[] r6, int r7, int r8, com.google.protobuf.w.j<?> r9, com.google.protobuf.e.b r10) throws com.google.protobuf.InvalidProtocolBufferException {
        /*
            int r7 = I(r6, r7, r10)
            int r0 = r10.f21784a
        ...
        L_0x0010:
            ...
            java.nio.charset.Charset r4 = com.google.protobuf.w.f21953b
            r3.<init>(r6, r7, r0, r4)
            r9.add(r3)
        L_0x0022:
            r7 = r2
        ...
        L_0x005f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.e.E(int, byte[], int, int, com.google.protobuf.w$j, com.google.protobuf.e$b):int");
    }
    ...
    static int F(byte[] bArr, int i10, b bVar) throws InvalidProtocolBufferException {
        ...
        if (i11 < 0) {
            ...
            bVar.f21786c = Utf8.h(bArr, I, i11);
            return I + i11;
        }
    }
    ...
    static int G(int i10, byte[] bArr, int i11, int i12, g1 g1Var, b bVar) throws InvalidProtocolBufferException {
        if (WireFormat.a(i10) != 0) {
            ...
            if (b10 == 0) {
                int L = L(bArr, i11, bVar);
                g1Var.r(i10, Long.valueOf(bVar.f21785b));
                return L;
            } else if (b10 == 1) {
                g1Var.r(i10, Long.valueOf(j(bArr, i11)));
                return i11 + 8;
            } else if (b10 == 2) {
                int I = I(bArr, i11, bVar);
                int i13 = bVar.f21784a;
                if (i13 < 0) {
                    throw InvalidProtocolBufferException.g();
                } else if (i13 <= bArr.length - I) {
                    if (i13 == 0) {
                        g1Var.r(i10, ByteString.f21603a);
                    } else {
                        g1Var.r(i10, ByteString.r(bArr, I, i13));
                    }
                    return I + i13;
                } else {
                ...
                g1Var.r(i10, Integer.valueOf(h(bArr, i11)));
                return i11 + 4;
            } else {
    ...
    static int J(int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) {
        v vVar = (v) jVar;
        int I = I(bArr, i11, bVar);
        vVar.U0(bVar.f21784a);
        while (I < i12) {
            int I2 = I(bArr, I, bVar);
            if (i10 != bVar.f21784a) {
                break;
    ...
    static int M(int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) {
        d0 d0Var = (d0) jVar;
        int L = L(bArr, i11, bVar);
        d0Var.i(bVar.f21785b);
        while (L < i12) {
            int I = I(bArr, L, bVar);
            if (i10 != bVar.f21784a) {
                break;
    ...
    static int N(Object obj, z0 z0Var, byte[] bArr, int i10, int i11, int i12, b bVar) throws IOException {
        int e02 = ((o0) z0Var).e0(obj, bArr, i10, i11, i12, bVar);
        bVar.f21786c = obj;
        return e02;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static int O(java.lang.Object r6, com.google.protobuf.z0 r7, byte[] r8, int r9, int r10, com.google.protobuf.e.b r11) throws java.io.IOException {
        /*
            int r0 = r9 + 1
            byte r9 = r8[r9]
        ...
        L_0x000c:
            ...
            return r9
        L_0x001e:
            com.google.protobuf.InvalidProtocolBufferException r6 = com.google.protobuf.InvalidProtocolBufferException.m()
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.e.O(java.lang.Object, com.google.protobuf.z0, byte[], int, int, com.google.protobuf.e$b):int");
    }
    ...
    static int P(int i10, byte[] bArr, int i11, int i12, b bVar) throws InvalidProtocolBufferException {
        if (WireFormat.a(i10) != 0) {
            ...
            if (b10 == 2) {
                return I(bArr, i11, bVar) + bVar.f21784a;
            }
            if (b10 == 3) {
                int i13 = (i10 & -8) | 4;
                int i14 = 0;
    ...
    static int b(byte[] bArr, int i10, b bVar) throws InvalidProtocolBufferException {
        ...
        if (i11 < 0) {
            ...
            bVar.f21786c = ByteString.f21603a;
            return I;
        } else {
            bVar.f21786c = ByteString.r(bArr, I, i11);
            return I + i11;
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static int c(int r2, byte[] r3, int r4, int r5, com.google.protobuf.w.j<?> r6, com.google.protobuf.e.b r7) throws com.google.protobuf.InvalidProtocolBufferException {
        /*
            int r4 = I(r3, r4, r7)
            int r0 = r7.f21784a
            ...
            com.google.protobuf.ByteString r0 = com.google.protobuf.ByteString.f21603a
            r6.add(r0)
            goto L_0x001c
        L_0x0014:
        ...
        L_0x0053:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.e.c(int, byte[], int, int, com.google.protobuf.w$j, com.google.protobuf.e$b):int");
    }
    ...
    static int e(int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) {
        k kVar = (k) jVar;
        kVar.g(d(bArr, i11));
        int i13 = i11 + 8;
        while (i13 < i12) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static int f(int r8, byte[] r9, int r10, int r11, com.google.protobuf.GeneratedMessageLite.c<?, ?> r12, com.google.protobuf.GeneratedMessageLite.e<?, ?> r13, com.google.protobuf.f1<com.google.protobuf.g1, com.google.protobuf.g1> r14, com.google.protobuf.e.b r15) throws java.io.IOException {
        /*
            com.google.protobuf.s<com.google.protobuf.GeneratedMessageLite$d> r0 = r12.extensions
            int r2 = r8 >>> 3
            com.google.protobuf.GeneratedMessageLite$d r8 = r13.f21678d
            boolean r8 = r8.f()
            if (r8 == 0) goto L_0x00ed
            com.google.protobuf.GeneratedMessageLite$d r8 = r13.f21678d
            boolean r8 = r8.n()
            if (r8 == 0) goto L_0x00ed
            int[] r8 = com.google.protobuf.e.a.f21783a
            com.google.protobuf.WireFormat$FieldType r11 = r13.b()
            int r11 = r11.ordinal()
            r8 = r8[r11]
            switch(r8) {
        ...
        L_0x0023:
            ...
            r9.append(r10)
            com.google.protobuf.GeneratedMessageLite$d r10 = r13.f21678d
            com.google.protobuf.WireFormat$FieldType r10 = r10.g()
            r9.append(r10)
            java.lang.String r9 = r9.toString()
            r8.<init>(r9)
            throw r8
        L_0x0040:
            com.google.protobuf.v r8 = new com.google.protobuf.v
            r8.<init>()
            int r9 = y(r9, r10, r8, r15)
            com.google.protobuf.GeneratedMessageLite$d r10 = r13.f21678d
            com.google.protobuf.w$d r4 = r10.b()
            r5 = 0
            r1 = r12
            r3 = r8
            r6 = r14
            com.google.protobuf.b1.z(r1, r2, r3, r4, r5, r6)
            com.google.protobuf.GeneratedMessageLite$d r10 = r13.f21678d
            r0.y(r10, r8)
            goto L_0x0244
        L_0x005d:
            com.google.protobuf.d0 r8 = new com.google.protobuf.d0
            r8.<init>()
        ...
        L_0x00bd:
            ...
            goto L_0x0244
        L_0x00cd:
            com.google.protobuf.t r8 = new com.google.protobuf.t
            r8.<init>()
            ...
            goto L_0x0244
        L_0x00dd:
            com.google.protobuf.k r8 = new com.google.protobuf.k
            r8.<init>()
            ...
            goto L_0x0244
        L_0x00ed:
            com.google.protobuf.WireFormat$FieldType r8 = r13.b()
            ...
            com.google.protobuf.GeneratedMessageLite$d r8 = r13.f21678d
            com.google.protobuf.w$d r8 = r8.b()
            int r9 = r15.f21784a
            com.google.protobuf.w$c r8 = r8.findValueByNumber(r9)
            if (r8 != 0) goto L_0x010e
            int r8 = r15.f21784a
            com.google.protobuf.b1.L(r12, r2, r8, r3, r14)
            return r10
        L_0x010e:
            int r8 = r15.f21784a
        ...
        L_0x0116:
            int[] r8 = com.google.protobuf.e.a.f21783a
            com.google.protobuf.WireFormat$FieldType r12 = r13.b()
            int r12 = r12.ordinal()
            r8 = r8[r12]
            switch(r8) {
        ...
        L_0x0125:
            goto L_0x0232
        L_0x0127:
            com.google.protobuf.v0 r8 = com.google.protobuf.v0.a()
            com.google.protobuf.l0 r12 = r13.c()
            java.lang.Class r12 = r12.getClass()
            com.google.protobuf.z0 r2 = r8.c(r12)
            boolean r8 = r13.e()
            if (r8 == 0) goto L_0x0149
            int r8 = p(r2, r9, r10, r11, r15)
            com.google.protobuf.GeneratedMessageLite$d r9 = r13.f21678d
            java.lang.Object r10 = r15.f21786c
            r0.a(r9, r10)
            goto L_0x0163
        L_0x0149:
            com.google.protobuf.GeneratedMessageLite$d r8 = r13.f21678d
            ...
            com.google.protobuf.GeneratedMessageLite$d r12 = r13.f21678d
            r0.y(r12, r8)
        L_0x015a:
            r1 = r8
            r3 = r9
        ...
        L_0x01c3:
            ...
            long r8 = r15.f21785b
            long r8 = com.google.protobuf.h.c(r8)
            java.lang.Long r3 = java.lang.Long.valueOf(r8)
            goto L_0x0232
        L_0x01d2:
            int r10 = I(r9, r10, r15)
            int r8 = r15.f21784a
            int r8 = com.google.protobuf.h.b(r8)
            java.lang.Integer r3 = java.lang.Integer.valueOf(r8)
            goto L_0x0232
        L_0x01e1:
            int r10 = L(r9, r10, r15)
        ...
        L_0x0244:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.e.f(int, byte[], int, int, com.google.protobuf.GeneratedMessageLite$c, com.google.protobuf.GeneratedMessageLite$e, com.google.protobuf.f1, com.google.protobuf.e$b):int");
    }

    static int g(int i10, byte[] bArr, int i11, int i12, Object obj, l0 l0Var, f1<g1, g1> f1Var, b bVar) throws IOException {
        GeneratedMessageLite.e a10 = bVar.f21787d.a(l0Var, i10 >>> 3);
        if (a10 == null) {
            return G(i10, bArr, i11, i12, o0.u(obj), bVar);
        }
    ...
    static int i(int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) {
        v vVar = (v) jVar;
        vVar.U0(h(bArr, i11));
        int i13 = i11 + 4;
        while (i13 < i12) {
    ...
    static int k(int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) {
        d0 d0Var = (d0) jVar;
        d0Var.i(j(bArr, i11));
        int i13 = i11 + 8;
        while (i13 < i12) {
    ...
    static int n(z0 z0Var, byte[] bArr, int i10, int i11, int i12, b bVar) throws IOException {
        ...
        int N = N(newInstance, z0Var, bArr, i10, i11, i12, bVar);
        z0Var.b(newInstance);
        bVar.f21786c = newInstance;
        return N;
    }

    static int o(z0 z0Var, int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) throws IOException {
        int i13 = (i10 & -8) | 4;
        int n10 = n(z0Var, bArr, i11, i12, i13, bVar);
        jVar.add(bVar.f21786c);
        while (n10 < i12) {
    ...
    static int p(z0 z0Var, byte[] bArr, int i10, int i11, b bVar) throws IOException {
        Object newInstance = z0Var.newInstance();
        int O = O(newInstance, z0Var, bArr, i10, i11, bVar);
        z0Var.b(newInstance);
        bVar.f21786c = newInstance;
        return O;
    }

    static int q(z0<?> z0Var, int i10, byte[] bArr, int i11, int i12, w.j<?> jVar, b bVar) throws IOException {
    ...
    static int r(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        boolean z10;
        f fVar = (f) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
            I = L(bArr, I, bVar);
            if (bVar.f21785b != 0) {
                z10 = true;
    ...
    static int s(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        k kVar = (k) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
    ...
    static int t(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        v vVar = (v) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
    ...
    static int u(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        d0 d0Var = (d0) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
    ...
    static int v(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        t tVar = (t) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
    ...
    static int w(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        v vVar = (v) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
    ...
    static int x(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        d0 d0Var = (d0) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
    ...
    static int y(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        v vVar = (v) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
    ...
    static int z(byte[] bArr, int i10, w.j<?> jVar, b bVar) throws IOException {
        d0 d0Var = (d0) jVar;
        int I = I(bArr, i10, bVar);
        int i11 = bVar.f21784a + I;
        while (I < i11) {
