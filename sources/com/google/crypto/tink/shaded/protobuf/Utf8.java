...
final class Utf8 {
    ...
    private static final b f20702a;
    ...
    static final class c extends b {
        ...
        public int d(int r7, byte[] r8, int r9, int r10) {
            ...
            L_0x001c:
                ...
                int r7 = com.google.crypto.tink.shaded.protobuf.Utf8.j(r0, r9)
                return r7
            L_0x0031:
                r5 = r9
                r9 = r7
            ...
            L_0x0049:
                ...
                int r7 = com.google.crypto.tink.shaded.protobuf.Utf8.j(r0, r1)
                return r7
            L_0x005b:
                r9 = r7
                goto L_0x0060
            ...
            L_0x0060:
                ...
                int r7 = com.google.crypto.tink.shaded.protobuf.Utf8.k(r0, r1, r4)
                return r7
            L_0x006d:
                r9 = r7
            L_0x006e:
            ...
            L_0x0082:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.Utf8.c.d(int, byte[], int, int):int");
        }
    }
    ...
    static final class d extends b {
        ...
        private static int f(byte[] r8, long r9, int r11) {
            ...
            L_0x0009:
                ...
                long r4 = r9 + r2
                byte r1 = com.google.crypto.tink.shaded.protobuf.j1.s(r8, r9)
            ...
            L_0x0029:
                ...
                long r2 = r2 + r9
                byte r9 = com.google.crypto.tink.shaded.protobuf.j1.s(r8, r9)
            ...
            L_0x005c:
                long r2 = r2 + r6
                byte r9 = com.google.crypto.tink.shaded.protobuf.j1.s(r8, r6)
                if (r9 <= r4) goto L_0x0037
            L_0x0063:
                return r5
            L_0x0064:
            ...
            L_0x006c:
                ...
                long r9 = r6 + r2
                byte r0 = com.google.crypto.tink.shaded.protobuf.j1.s(r8, r6)
            ...
            L_0x008e:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.Utf8.d.f(byte[], long, int):int");
        }
        ...
        private static int h(byte[] bArr, int i10, long j10, int i11) {
            ...
            if (i11 == 1) {
                return Utf8.j(i10, j1.s(bArr, j10));
            }
            if (i11 == 2) {
                return Utf8.k(i10, j1.s(bArr, j10), j1.s(bArr, j10 + 1));
            }
        ...
        public String a(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
            if ((i10 | i11 | ((bArr.length - i10) - i11)) >= 0) {
                ...
                while (r13 < i12) {
                    int i15 = r13 + 1;
                    byte s11 = j1.s(bArr, (long) r13);
                    if (a.n(s11)) {
                        int i16 = i14 + 1;
                        a.i(s11, cArr, i14);
                        while (i15 < i12) {
                            byte s12 = j1.s(bArr, (long) i15);
                            if (!a.n(s12)) {
                                break;
                            }
                            i15++;
                        ...
                        if (i15 < i12) {
                            a.k(s11, j1.s(bArr, (long) i15), cArr, i14);
                            r13 = i15 + 1;
                            i14++;
                        } else {
                            throw InvalidProtocolBufferException.c();
                        ...
                        if (i15 < i12 - 1) {
                            int i17 = i15 + 1;
                            a.j(s11, j1.s(bArr, (long) i15), j1.s(bArr, (long) i17), cArr, i14);
                            r13 = i17 + 1;
                            i14++;
                        } else {
                            throw InvalidProtocolBufferException.c();
                        ...
                        int i18 = i15 + 1;
                        byte s13 = j1.s(bArr, (long) i15);
                        int i19 = i18 + 1;
                        a.h(s11, s13, j1.s(bArr, (long) i18), j1.s(bArr, (long) i19), cArr, i14);
                        r13 = i19 + 1;
                        i14 = i14 + 1 + 1;
                    } else {
                        throw InvalidProtocolBufferException.c();
        ...
        public int b(java.lang.CharSequence r22, byte[] r23, int r24, int r25) {
            ...
            L_0x001a:
                ...
                long r11 = r11 + r4
                byte r3 = (byte) r13
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r4, r3)
                int r2 = r2 + 1
                r4 = r11
                goto L_0x001a
            L_0x002f:
            ...
            L_0x0033:
                ...
                long r14 = r4 + r11
                byte r13 = (byte) r13
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r4, r13)
                r4 = r11
                r12 = r14
                r11 = r3
                goto L_0x00fc
            L_0x004a:
                ...
                r5 = r5 | r13
                byte r5 = (byte) r5
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r14, r5)
                r19 = r11
            ...
            L_0x007e:
                ...
                r5 = r5 | r11
                byte r5 = (byte) r5
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r3, r5)
                r12 = r17
                r4 = 1
                r11 = 128(0x80, float:1.794E-43)
                goto L_0x00fc
            L_0x00af:
                ...
                byte r15 = (byte) r15
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r4, r15)
                long r4 = r13 + r11
                int r15 = r2 >>> 12
                r15 = r15 & 63
                r11 = 128(0x80, float:1.794E-43)
                ...
                byte r12 = (byte) r12
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r13, r12)
                r12 = 1
                long r14 = r4 + r12
                int r16 = r2 >>> 6
                r12 = r16 & 63
                r12 = r12 | r11
                byte r12 = (byte) r12
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r4, r12)
                r4 = 1
                long r12 = r14 + r4
                r2 = r2 & 63
                r2 = r2 | r11
                byte r2 = (byte) r2
                com.google.crypto.tink.shaded.protobuf.j1.H(r1, r14, r2)
                r2 = r3
            L_0x00fc:
                int r2 = r2 + 1
                r3 = r11
            ...
            L_0x0144:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.Utf8.d.b(java.lang.CharSequence, byte[], int, int):int");
        }

        /* access modifiers changed from: package-private */
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0059, code lost:
            if (com.google.crypto.tink.shaded.protobuf.j1.s(r13, r2) > -65) goto L_0x005e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x009e, code lost:
            if (com.google.crypto.tink.shaded.protobuf.j1.s(r13, r2) > -65) goto L_0x00a0;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int d(int r12, byte[] r13, int r14, int r15) {
            ...
            L_0x0011:
                ...
                long r7 = r7 + r2
                byte r12 = com.google.crypto.tink.shaded.protobuf.j1.s(r13, r2)
            ...
            L_0x002b:
                ...
                int r12 = com.google.crypto.tink.shaded.protobuf.Utf8.j(r0, r12)
                return r12
            L_0x0044:
                r2 = r9
            L_0x0045:
            ...
            L_0x005f:
                ...
                long r9 = r2 + r7
                byte r4 = com.google.crypto.tink.shaded.protobuf.j1.s(r13, r2)
                int r12 = (r9 > r14 ? 1 : (r9 == r14 ? 0 : -1))
                if (r12 < 0) goto L_0x0074
                int r12 = com.google.crypto.tink.shaded.protobuf.Utf8.j(r0, r4)
                return r12
            L_0x0074:
                r2 = r9
                goto L_0x0079
            ...
            L_0x0079:
                ...
                long r9 = r2 + r7
                byte r1 = com.google.crypto.tink.shaded.protobuf.j1.s(r13, r2)
                int r12 = (r9 > r14 ? 1 : (r9 == r14 ? 0 : -1))
                if (r12 < 0) goto L_0x008a
                int r12 = com.google.crypto.tink.shaded.protobuf.Utf8.k(r0, r4, r1)
                return r12
            L_0x008a:
                r2 = r9
            L_0x008b:
            ...
            L_0x00a8:
                ...
                throw r12
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.Utf8.d.d(int, byte[], int, int):int");
        }
    }
    ...
    static String e(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
        return f20702a.a(bArr, i10, i11);
    }

    static int f(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        return f20702a.b(charSequence, bArr, i10, i11);
    }
    ...
    public static boolean m(byte[] bArr) {
        return f20702a.c(bArr, 0, bArr.length);
    }

    public static boolean n(byte[] bArr, int i10, int i11) {
        return f20702a.c(bArr, i10, i11);
    }
}
