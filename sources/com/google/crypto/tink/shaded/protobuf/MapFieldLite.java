...
public final class MapFieldLite<K, V> extends LinkedHashMap<K, V> {
    ...
    private static final MapFieldLite f20698a;
    private boolean isMutable = true;

    static {
        MapFieldLite mapFieldLite = new MapFieldLite();
        f20698a = mapFieldLite;
        mapFieldLite.l();
    }
    ...
    static <K, V> boolean j(java.util.Map<K, V> r4, java.util.Map<K, V> r5) {
        ...
        L_0x0042:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.MapFieldLite.j(java.util.Map, java.util.Map):boolean");
    }
