...
interface Writer {
    ...
    <K, V> void J(int i10, f0.a<K, V> aVar, Map<K, V> map) throws IOException;

    @Deprecated
    void K(int i10, Object obj, z0 z0Var) throws IOException;

    void L(int i10, List<?> list, z0 z0Var) throws IOException;

    void M(int i10, ByteString byteString) throws IOException;

    void N(int i10, Object obj, z0 z0Var) throws IOException;

    @Deprecated
    void O(int i10, List<?> list, z0 z0Var) throws IOException;
