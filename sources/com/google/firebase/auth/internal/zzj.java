...
public final class zzj {
    ...
    public final synchronized com.google.firebase.auth.internal.zzi zza(android.content.Context r11, java.lang.String r12, java.lang.String r13) {
        /*
            r10 = this;
            monitor-enter(r10)
            com.google.android.gms.common.internal.p.g(r12)     // Catch:{ all -> 0x006f }
            com.google.android.gms.common.internal.p.g(r13)     // Catch:{ all -> 0x006f }
    ...
    public final synchronized String zzc(Context context, String str, String str2) {
        ...
        String format2 = String.format("com.google.firebase.auth.internal.EVENT_ID.%s.OPERATION", new Object[]{str2});
        string = zzg.getString(format2, (String) null);
        String format3 = String.format("com.google.firebase.auth.internal.EVENT_ID.%s.FIREBASE_APP_NAME", new Object[]{str2});
        string2 = zzg.getString(format3, (String) null);
