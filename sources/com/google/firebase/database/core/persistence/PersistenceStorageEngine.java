...
public interface PersistenceStorageEngine {
    ...
    Set<ChildKey> loadTrackedQueryKeys(long j10);
    ...
    void saveTrackedQueryKeys(long j10, Set<ChildKey> set);

    void saveUserMerge(Path path, CompoundWrite compoundWrite, long j10);

    void saveUserOverwrite(Path path, Node node, long j10);
    ...
    void updateTrackedQueryKeys(long j10, Set<ChildKey> set, Set<ChildKey> set2);
}
