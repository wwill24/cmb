...
public class CustomClassMapper {
    ...
    private static class BeanMapper<T> {
        ...
        public Map<String, Object> serialize(T t10) {
            Object obj;
            if (this.clazz.isAssignableFrom(t10.getClass())) {
                HashMap hashMap = new HashMap();
                for (String next : this.properties.values()) {
                    if (this.getters.containsKey(next)) {
                        try {
                            obj = this.getters.get(next).invoke(t10, new Object[0]);
            ...
            throw new IllegalArgumentException("Can't serialize object of class " + t10.getClass() + " with BeanMapper for class " + this.clazz);
        }
    ...
    private static <T> BeanMapper<T> loadOrCreateBeanMapperForClass(Class<T> cls) {
        ...
        BeanMapper<T> beanMapper = concurrentMap.get(cls);
        if (beanMapper != null) {
            return beanMapper;
        }
    ...
    /* access modifiers changed from: private */
    public static <T> Object serialize(T t10) {
        if (t10 == null) {
            return null;
        }
        if (t10 instanceof Number) {
            if ((t10 instanceof Float) || (t10 instanceof Double)) {
                ...
                throw new DatabaseException(String.format("Numbers of type %s are not supported, please use an int, long, float or double", new Object[]{t10.getClass().getSimpleName()}));
            }
            ...
            if (t10 instanceof Character) {
                ...
                return loadOrCreateBeanMapperForClass(t10.getClass()).serialize(t10);
            }
        }
    }
