...
public class OnDisconnect {
    ...
    public void updateChildren(@NonNull Map<String, Object> map, DatabaseReference.CompletionListener completionListener) {
        updateChildrenInternal(map, completionListener);
    }

    @NonNull
    public Task<Void> setValue(Object obj, double d10) {
        return onDisconnectSetInternal(obj, PriorityUtilities.parsePriority(this.path, Double.valueOf(d10)), (DatabaseReference.CompletionListener) null);
    }
