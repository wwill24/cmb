...
public class DatabaseError {
    ...
    private DatabaseError(int i10, String str) {
        this(i10, str, (String) null);
    }

    public static DatabaseError fromCode(int i10) {
        Map<Integer, String> map = errorReasons;
        if (map.containsKey(Integer.valueOf(i10))) {
            return new DatabaseError(i10, map.get(Integer.valueOf(i10)), (String) null);
        }
        throw new IllegalArgumentException("Invalid Firebase Database error code: " + i10);
    }

    @NonNull
    public static DatabaseError fromException(@NonNull Throwable th2) {
    ...
    private DatabaseError(int i10, String str, String str2) {
        this.code = i10;
        this.message = str;
