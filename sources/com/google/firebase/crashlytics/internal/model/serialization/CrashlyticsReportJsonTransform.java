...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 96801:
                    ...
                    break;
                case 107332:
                    if (nextName.equals(RequestBuilder.ACTION_LOG)) {
                        c10 = 2;
                        break;
                    }
                    break;
    ...
    private static CrashlyticsReport.Session.Event.Application parseEventApp(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1332194002:
                    if (nextName.equals(Constants.Params.BACKGROUND)) {
                        c10 = 0;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 3530753:
                    ...
                    break;
                case 3601339:
                    if (nextName.equals(Constants.Params.UUID)) {
                        c10 = 2;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1266514778:
                    ...
                    break;
                case -934964668:
                    if (nextName.equals(JingleReason.ELEMENT)) {
                        c10 = 1;
                        break;
                    }
                    break;
    ...
    public static CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame parseEventFrame(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1019779949:
                    if (nextName.equals(Range.ATTR_OFFSET)) {
                        c10 = 0;
                        break;
                    }
                    break;
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            String nextName = jsonReader.nextName();
            nextName.hashCode();
            if (nextName.equals(Constants.Keys.FILES)) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1335157162:
                    ...
                    break;
                case -1291329255:
                    if (nextName.equals(Constants.Params.API_EVENTS_STATE)) {
                        c10 = 5;
                        break;
                    }
                    break;
                case 3556:
                    if (nextName.equals(SoftwareInfoForm.OS)) {
                        c10 = 6;
                        break;
                    }
                    break;
