...
public final class SessionEvent {
    ...
    public SessionEvent(EventType eventType2, SessionInfo sessionInfo, ApplicationInfo applicationInfo2) {
        j.g(eventType2, "eventType");
        j.g(sessionInfo, "sessionData");
        j.g(applicationInfo2, "applicationInfo");
    ...
    public boolean equals(Object obj) {
        ...
        return this.eventType == sessionEvent.eventType && j.b(this.sessionData, sessionEvent.sessionData) && j.b(this.applicationInfo, sessionEvent.applicationInfo);
    }
    ...
    public String toString() {
        return "SessionEvent(eventType=" + this.eventType + ", sessionData=" + this.sessionData + ", applicationInfo=" + this.applicationInfo + PropertyUtils.MAPPED_DELIM2;
    }
}
