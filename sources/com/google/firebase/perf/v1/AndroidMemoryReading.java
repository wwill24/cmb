...
public final class AndroidMemoryReading extends GeneratedMessageLite<AndroidMemoryReading, Builder> implements AndroidMemoryReadingOrBuilder {
    ...
    private static volatile t0<AndroidMemoryReading> PARSER = null;
    ...
    public static final class Builder extends GeneratedMessageLite.a<AndroidMemoryReading, Builder> implements AndroidMemoryReadingOrBuilder {
    ...
    public static t0<AndroidMemoryReading> parser() {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                t0<AndroidMemoryReading> t0Var = PARSER;
                if (t0Var == null) {
    ...
    public static AndroidMemoryReading parseDelimitedFrom(InputStream inputStream, n nVar) throws IOException {
        return (AndroidMemoryReading) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, nVar);
    }

    public static AndroidMemoryReading parseFrom(ByteBuffer byteBuffer, n nVar) throws InvalidProtocolBufferException {
        return (AndroidMemoryReading) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, nVar);
    }
    ...
    public static AndroidMemoryReading parseFrom(ByteString byteString, n nVar) throws InvalidProtocolBufferException {
        return (AndroidMemoryReading) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, nVar);
    }
    ...
    public static AndroidMemoryReading parseFrom(byte[] bArr, n nVar) throws InvalidProtocolBufferException {
        return (AndroidMemoryReading) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, nVar);
    }
    ...
    public static AndroidMemoryReading parseFrom(InputStream inputStream, n nVar) throws IOException {
        return (AndroidMemoryReading) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, nVar);
    }

    public static AndroidMemoryReading parseFrom(h hVar) throws IOException {
        return (AndroidMemoryReading) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, hVar);
    }

    public static AndroidMemoryReading parseFrom(h hVar, n nVar) throws IOException {
        return (AndroidMemoryReading) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, hVar, nVar);
    }
}
