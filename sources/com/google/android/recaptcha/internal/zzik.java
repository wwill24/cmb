...
interface zzik {
    ...
    @Deprecated
    void zzC(List list, zzil zzil, zzfz zzfz) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzil zzil, zzfz zzfz) throws IOException;
    ...
    void zzt(Object obj, zzil zzil, zzfz zzfz) throws IOException;

    void zzu(Object obj, zzil zzil, zzfz zzfz) throws IOException;
