...
final class zzju {
    ...
    static String zzd(byte[] bArr, int i10, int i11) throws zzgy {
        int i12;
        ...
        if ((((length - i10) - i11) | i10 | i11) >= 0) {
            ...
            while (r11 < i13) {
                ...
                if (zzjq.zzd(b11)) {
                    ...
                    if (i15 < i13) {
                        zzjq.zzc(b11, bArr[i15], cArr, i12);
                        r11 = i15 + 1;
                        i12++;
                    } else {
                        throw zzgy.zzd();
                    ...
                    if (i15 < i13 - 1) {
                        int i17 = i15 + 1;
                        zzjq.zzb(b11, bArr[i15], bArr[i17], cArr, i12);
                        r11 = i17 + 1;
                        i12++;
                    } else {
                        throw zzgy.zzd();
                    ...
                    byte b13 = bArr[i15];
                    int i19 = i18 + 1;
                    zzjq.zza(b11, b13, bArr[i18], bArr[i19], cArr, i12);
                    i12 += 2;
                    r11 = i19 + 1;
                } else {
                    throw zzgy.zzd();
