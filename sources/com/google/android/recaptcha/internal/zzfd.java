...
final class zzfd extends zzff {
    ...
    /* synthetic */ zzfd(InputStream inputStream, int i10, zzfc zzfc) {
        super((zzfe) null);
        byte[] bArr = zzgw.zzd;
    ...
    public final zzez zzw() throws IOException {
        ...
        if (zzj2 <= i10 - i11 && zzj2 > 0) {
            zzez zzm = zzez.zzm(this.zzf, i11, zzj2);
            this.zzi += zzj2;
            return zzm;
        } else if (zzj2 == 0) {
            return zzez.zzb;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i11 = this.zzi;
            if (zzj2 <= i10 - i11) {
                String str = new String(this.zzf, i11, zzj2, zzgw.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
