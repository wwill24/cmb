...
public abstract class NetworkConnectionInfo {
    ...
    public enum MobileSubtype {
        ...
        private static final SparseArray<MobileSubtype> C = null;
        ...
        public static MobileSubtype a(int i10) {
            return C.get(i10);
        }
    ...
    public enum NetworkType {
        ...
        private static final SparseArray<NetworkType> f38024z = null;
        private final int value;
        ...
        public static NetworkType a(int i10) {
            return f38024z.get(i10);
        }
