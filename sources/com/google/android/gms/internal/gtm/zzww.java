...
interface zzww {
    ...
    @Deprecated
    <T> void zzF(List<T> list, zzwx<T> zzwx, zzuj zzuj) throws IOException;

    void zzG(List<Integer> list) throws IOException;

    void zzH(List<Long> list) throws IOException;

    <T> void zzI(List<T> list, zzwx<T> zzwx, zzuj zzuj) throws IOException;
    ...
    @Deprecated
    <T> T zzr(Class<T> cls, zzuj zzuj) throws IOException;

    @Deprecated
    <T> T zzs(zzwx<T> zzwx, zzuj zzuj) throws IOException;

    <T> T zzt(Class<T> cls, zzuj zzuj) throws IOException;

    <T> T zzu(zzwx<T> zzwx, zzuj zzuj) throws IOException;
