...
final class zzaju extends zzaiq implements RandomAccess, zzalw {
    private static final zzaju zza = new zzaju(new double[0], 0, false);
    private double[] zzb;
    private int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzakp zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzaju(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzaju(double[] dArr, int i10, boolean z10) {
        super(z10);
        this.zzb = dArr;
        this.zzc = i10;
    }
