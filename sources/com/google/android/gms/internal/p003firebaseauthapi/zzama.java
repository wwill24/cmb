...
interface zzama {
    ...
    @Deprecated
    void zzC(List list, zzamb zzamb, zzajx zzajx) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzamb zzamb, zzajx zzajx) throws IOException;
    ...
    zzajf zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzamb zzamb, zzajx zzajx) throws IOException;

    void zzu(Object obj, zzamb zzamb, zzajx zzajx) throws IOException;
