...
final class zzajj extends zzajl {
    ...
    /* synthetic */ zzajj(InputStream inputStream, int i10, zzaji zzaji) {
        super((zzajk) null);
        byte[] bArr = zzakq.zzd;
    ...
    public final int zze(int i10) throws zzaks {
        if (i10 >= 0) {
    ...
    public final int zzj() throws java.io.IOException {
        ...
        L_0x006d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p003firebaseauthapi.zzajj.zzj():int");
    }
    ...
    public final zzajf zzw() throws IOException {
        ...
        if (zzj2 <= i10 - i11 && zzj2 > 0) {
            zzajf zzn = zzajf.zzn(this.zzf, i11, zzj2);
            this.zzi += zzj2;
            return zzn;
        } else if (zzj2 == 0) {
            return zzajf.zzb;
            ...
            byte[] zzN = zzN(zzj2);
            if (zzN != null) {
                return zzajf.zzn(zzN, 0, zzN.length);
            }
            int i12 = this.zzi;
            int i13 = this.zzg;
            int i14 = i13 - i12;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i11 = this.zzi;
            if (zzj2 <= i10 - i11) {
                String str = new String(this.zzf, i11, zzj2, zzakq.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
        ...
        if (zzj2 > this.zzg) {
            return new String(zzM(zzj2, false), zzakq.zzb);
        }
        zzK(zzj2);
        String str2 = new String(this.zzf, this.zzi, zzj2, zzakq.zzb);
        this.zzi += zzj2;
        return str2;
    }
    ...
    public final String zzy() throws IOException {
        ...
        return zzank.zzd(bArr, i10, zzj2);
    }

    public final void zzz(int i10) throws zzaks {
        if (this.zzj != i10) {
            throw zzaks.zzb();
        }
    }
