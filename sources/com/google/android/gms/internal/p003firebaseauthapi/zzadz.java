...
public final class zzadz {
    ...
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        L_0x00aa:
            ...
            return r0
        L_0x00b6:
            com.google.firebase.auth.zzag r3 = new com.google.firebase.auth.zzag
            java.lang.String r0 = zzc(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x00c0:
        ...
        L_0x0100:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p003firebaseauthapi.zzadz.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }

    public static FirebaseException zzb(Status status, AuthCredential authCredential, String str, String str2) {
        int Y = status.Y();
        if (Y != 17012 && Y != 17007 && Y != 17025) {
            return zza(status);
        }
        FirebaseAuthUserCollisionException firebaseAuthUserCollisionException = new FirebaseAuthUserCollisionException(zzc(Y), zzd(zze(Y), status));
    ...
    private static String zzd(String str, Status status) {
        if (TextUtils.isEmpty(status.c0())) {
            return str;
        }
        String valueOf = String.valueOf(str);
        return String.format(valueOf.concat(" [ %s ]"), new Object[]{status.c0()});
    }
