...
final class zzanf {
    ...
    private static final zzane zzf;
    ...
    static {
        /*
            ...
            zzc = r0
            int r8 = com.google.android.gms.internal.p003firebaseauthapi.zzair.zza
        ...
        L_0x002c:
            ...
            com.google.android.gms.internal.firebase-auth-api.zzand r11 = new com.google.android.gms.internal.firebase-auth-api.zzand
            r11.<init>(r0)
            goto L_0x003b
        L_0x0034:
            if (r10 == 0) goto L_0x003b
            com.google.android.gms.internal.firebase-auth-api.zzanc r11 = new com.google.android.gms.internal.firebase-auth-api.zzanc
            r11.<init>(r0)
        L_0x003b:
            zzf = r11
        ...
        L_0x0069:
            r0 = move-exception
            java.util.logging.Logger.getLogger(com.google.android.gms.internal.p003firebaseauthapi.zzanf.class.getName()).logp(java.util.logging.Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(r0.toString()))
            goto L_0x0046
        L_0x006e:
            zzg = r0
            com.google.android.gms.internal.firebase-auth-api.zzane r0 = zzf
        ...
        L_0x0077:
            ...
            java.lang.Class[] r8 = new java.lang.Class[r13]     // Catch:{ all -> 0x00e9 }
            java.lang.Class<java.lang.reflect.Field> r11 = java.lang.reflect.Field.class
            r8[r14] = r11     // Catch:{ all -> 0x00e9 }
            r0.getMethod(r10, r8)     // Catch:{ all -> 0x00e9 }
            java.lang.String r8 = "arrayBaseOffset"
            java.lang.Class[] r10 = new java.lang.Class[r13]     // Catch:{ all -> 0x00e9 }
            java.lang.Class<java.lang.Class> r11 = java.lang.Class.class
            r10[r14] = r11     // Catch:{ all -> 0x00e9 }
            r0.getMethod(r8, r10)     // Catch:{ all -> 0x00e9 }
            ...
            java.lang.Class[] r10 = new java.lang.Class[r12]     // Catch:{ all -> 0x00e9 }
            r10[r14] = r7     // Catch:{ all -> 0x00e9 }
            java.lang.Class r11 = java.lang.Long.TYPE     // Catch:{ all -> 0x00e9 }
            r10[r13] = r11     // Catch:{ all -> 0x00e9 }
            r0.getMethod(r8, r10)     // Catch:{ all -> 0x00e9 }
            java.lang.String r8 = "putInt"
            r10 = 3
            java.lang.Class[] r15 = new java.lang.Class[r10]     // Catch:{ all -> 0x00e9 }
            r15[r14] = r7     // Catch:{ all -> 0x00e9 }
            r15[r13] = r11     // Catch:{ all -> 0x00e9 }
            java.lang.Class r16 = java.lang.Integer.TYPE     // Catch:{ all -> 0x00e9 }
            r15[r12] = r16     // Catch:{ all -> 0x00e9 }
            r0.getMethod(r8, r15)     // Catch:{ all -> 0x00e9 }
            java.lang.Class[] r8 = new java.lang.Class[r12]     // Catch:{ all -> 0x00e9 }
            r8[r14] = r7     // Catch:{ all -> 0x00e9 }
            r8[r13] = r11     // Catch:{ all -> 0x00e9 }
            r0.getMethod(r9, r8)     // Catch:{ all -> 0x00e9 }
            java.lang.String r8 = "putLong"
            java.lang.Class[] r9 = new java.lang.Class[r10]     // Catch:{ all -> 0x00e9 }
            r9[r14] = r7     // Catch:{ all -> 0x00e9 }
            r9[r13] = r11     // Catch:{ all -> 0x00e9 }
            r9[r12] = r11     // Catch:{ all -> 0x00e9 }
            r0.getMethod(r8, r9)     // Catch:{ all -> 0x00e9 }
        ...
        L_0x00ee:
            ...
            com.google.android.gms.internal.firebase-auth-api.zzane r1 = zzf
        ...
        L_0x0136:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p003firebaseauthapi.zzanf.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j10, byte b10) {
        zzane zzane = zzf;
        long j11 = -4 & j10;
        int i10 = zzane.zza.getInt(obj, j11);
        int i11 = ((~((int) j10)) & 3) << 3;
        zzane.zza.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(255 << i11))));
    }
    ...
    public static void zzE(Object obj, long j10, byte b10) {
        ...
        long j11 = -4 & j10;
        int i10 = (((int) j10) & 3) << 3;
        zzane.zza.putInt(obj, j11, ((255 & b10) << i10) | (zzane.zza.getInt(obj, j11) & (~(255 << i10))));
    }
    ...
    static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzanb());
        } catch (Throwable unused) {
            return null;
        }
    }
