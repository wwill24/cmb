...
final class zzake extends zzaiq implements RandomAccess, zzalw {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (a.e.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzake.zzb, 0, this.zzb, this.zzc, zzake.zzc);
            this.zzc = i12;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzake.zzc) {
            return false;
        }
        float[] fArr = zzake.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzakp zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzake(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzake(float[] fArr, int i10, boolean z10) {
        super(z10);
        this.zzb = fArr;
        this.zzc = i10;
    }
