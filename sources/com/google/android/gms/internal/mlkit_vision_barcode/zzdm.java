...
final class zzdm implements ObjectEncoderContext {
    private static final Charset zza = Charset.forName("UTF-8");
    private static final FieldDescriptor zzb;
    private static final FieldDescriptor zzc;
    private static final ObjectEncoder zzd = zzdl.zza;
    ...
    zzdm(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzdk zzdk = (zzdk) fieldDescriptor.getProperty(zzdk.class);
        if (zzdk != null) {
            return zzdk.zza();
        }
    ...
    private static zzdk zzj(FieldDescriptor fieldDescriptor) {
        zzdk zzdk = (zzdk) fieldDescriptor.getProperty(zzdk.class);
        if (zzdk != null) {
            return zzdk;
        }
    ...
    private final zzdm zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    private final zzdm zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    public final ObjectEncoderContext zzc(@NonNull FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                zzd(fieldDescriptor, ((zzdi) obj).zza(), true);
                return this;
    ...
    /* access modifiers changed from: package-private */
    public final zzdm zzd(@NonNull FieldDescriptor fieldDescriptor, int i10, boolean z10) throws IOException {
        if (z10 && i10 == 0) {
            return this;
        }
        zzdk zzj = zzj(fieldDescriptor);
    ...
    /* access modifiers changed from: package-private */
    public final zzdm zze(@NonNull FieldDescriptor fieldDescriptor, long j10, boolean z10) throws IOException {
        if (z10 && j10 == 0) {
            return this;
        }
        zzdk zzj = zzj(fieldDescriptor);
    ...
    /* access modifiers changed from: package-private */
    public final zzdm zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
