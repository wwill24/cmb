...
final class zzak implements ObjectEncoderContext {
    ...
    private final zzak zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    private final zzak zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    /* access modifiers changed from: package-private */
    public final zzak zzd(@NonNull FieldDescriptor fieldDescriptor, int i10, boolean z10) throws IOException {
        if (z10 && i10 == 0) {
            return this;
        }
    ...
    /* access modifiers changed from: package-private */
    public final zzak zze(@NonNull FieldDescriptor fieldDescriptor, long j10, boolean z10) throws IOException {
        if (z10 && j10 == 0) {
            return this;
        }
        zzai zzj = zzj(fieldDescriptor);
