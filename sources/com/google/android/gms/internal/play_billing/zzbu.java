...
final class zzbu extends zzal implements RandomAccess, zzdm {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (a.e.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzbu.zzb, 0, this.zzb, this.zzc, zzbu.zzc);
            this.zzc = i12;
            this.modCount++;
            return true;
        }
    ...
    public final /* bridge */ /* synthetic */ zzcf zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzbu(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzbu(float[] fArr, int i10, boolean z10) {
        super(z10);
        this.zzb = fArr;
        this.zzc = i10;
    }
