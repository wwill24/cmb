...
final class zzbk extends zzal implements RandomAccess, zzdm {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (a.e.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzbk.zzb, 0, this.zzb, this.zzc, zzbk.zzc);
            this.zzc = i12;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzbk zzbk = (zzbk) obj;
        if (this.zzc != zzbk.zzc) {
            return false;
        }
        double[] dArr = zzbk.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzcf zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzbk(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzbk(double[] dArr, int i10, boolean z10) {
        super(z10);
        this.zzb = dArr;
        this.zzc = i10;
    }
