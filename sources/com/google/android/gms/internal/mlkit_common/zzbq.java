...
final class zzbq implements ObjectEncoderContext {
    ...
    private final zzbq zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    private final zzbq zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    /* access modifiers changed from: package-private */
    public final zzbq zzd(@NonNull FieldDescriptor fieldDescriptor, int i10, boolean z10) throws IOException {
        if (z10 && i10 == 0) {
            return this;
        }
    ...
    /* access modifiers changed from: package-private */
    public final zzbq zze(@NonNull FieldDescriptor fieldDescriptor, long j10, boolean z10) throws IOException {
        if (z10 && j10 == 0) {
            return this;
        }
        zzbo zzj = zzj(fieldDescriptor);
