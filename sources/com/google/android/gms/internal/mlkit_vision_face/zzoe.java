...
public final class zzoe {
    ...
    public final synchronized void zzc(int i10, int i11, long j10, long j11) {
        synchronized (this) {
            ...
            this.zza.a(new TelemetryData(0, Arrays.asList(new MethodInvocation[]{new MethodInvocation(i10, i11, 0, j10, j11, (String) null, (String) null, 0)}))).addOnFailureListener(new zzod(this, elapsedRealtime));
        }
    }
}
