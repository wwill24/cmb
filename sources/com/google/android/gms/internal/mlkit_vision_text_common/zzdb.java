...
final class zzdb implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder zzd = zzda.zza;
    ...
    zzdb(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzcz zzcz = (zzcz) fieldDescriptor.getProperty(zzcz.class);
        if (zzcz != null) {
            return zzcz.zza();
        }
    ...
    private static zzcz zzj(FieldDescriptor fieldDescriptor) {
        zzcz zzcz = (zzcz) fieldDescriptor.getProperty(zzcz.class);
        if (zzcz != null) {
            return zzcz;
        }
    ...
    private final zzdb zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    private final zzdb zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
    ...
    public final ObjectEncoderContext zzc(@NonNull FieldDescriptor fieldDescriptor, Object obj, boolean z10) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                zzd(fieldDescriptor, ((zzcx) obj).zza(), true);
                return this;
    ...
    /* access modifiers changed from: package-private */
    public final zzdb zzd(@NonNull FieldDescriptor fieldDescriptor, int i10, boolean z10) throws IOException {
        if (z10 && i10 == 0) {
            return this;
        }
        zzcz zzj = zzj(fieldDescriptor);
        zzcy zzcy = zzcy.DEFAULT;
    ...
    /* access modifiers changed from: package-private */
    public final zzdb zze(@NonNull FieldDescriptor fieldDescriptor, long j10, boolean z10) throws IOException {
        if (z10 && j10 == 0) {
            return this;
        }
        zzcz zzj = zzj(fieldDescriptor);
