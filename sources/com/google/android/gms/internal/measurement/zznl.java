...
public final class zznl {
    ...
    static zznl zze(zznl zznl, zznl zznl2) {
        int i10 = zznl.zzb + zznl2.zzb;
        int[] copyOf = Arrays.copyOf(zznl.zzc, i10);
        System.arraycopy(zznl2.zzc, 0, copyOf, zznl.zzb, zznl2.zzb);
        Object[] copyOf2 = Arrays.copyOf(zznl.zzd, i10);
        ...
        for (int i15 = 0; i15 < this.zzb; i15++) {
            ...
            if (i18 != 0) {
                if (i18 == 1) {
                    ...
                    i10 = zzki.zzx(i17 << 3) + 8;
                } else if (i18 == 2) {
                    int i19 = zzki.zzb;
                    int zzd2 = ((zzka) this.zzd[i15]).zzd();
                    i10 = zzki.zzx(i17 << 3) + zzki.zzx(zzd2) + zzd2;
                } else if (i18 == 3) {
                    int i20 = i17 << 3;
                    int i21 = zzki.zzb;
                    i11 = ((zznl) this.zzd[i15]).zza();
                    int zzx = zzki.zzx(i20);
                    i12 = zzx + zzx;
                } else if (i18 == 5) {
                    ((Integer) this.zzd[i15]).intValue();
                    i10 = zzki.zzx(i17 << 3) + 4;
                } else {
                ...
                int i22 = i17 << 3;
                i11 = zzki.zzy(((Long) this.zzd[i15]).longValue());
                i12 = zzki.zzx(i22);
            }
            i10 = i12 + i11;
            i14 += i10;
    ...
    public final int zzb() {
        ...
        for (int i12 = 0; i12 < this.zzb; i12++) {
            int i13 = zzki.zzb;
            int zzd2 = ((zzka) this.zzd[i12]).zzd();
    ...
    public final void zzk(zzoc zzoc) throws IOException {
        if (this.zzb != 0) {
            for (int i10 = 0; i10 < this.zzb; i10++) {
                ...
                int i13 = i11 >>> 3;
                if (i12 == 0) {
                    zzoc.zzt(i13, ((Long) obj).longValue());
                } else if (i12 == 1) {
                    zzoc.zzm(i13, ((Long) obj).longValue());
                } else if (i12 == 2) {
                    zzoc.zzd(i13, (zzka) obj);
                } else if (i12 == 3) {
                    zzoc.zzE(i13);
                    ((zznl) obj).zzk(zzoc);
                    zzoc.zzh(i13);
                } else if (i12 == 5) {
                    zzoc.zzk(i13, ((Integer) obj).intValue());
                } else {
