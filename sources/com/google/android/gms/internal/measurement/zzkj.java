...
final class zzkj implements zzoc {
    ...
    public final void zzB(int i10, List list, boolean z10) throws IOException {
        ...
        while (i11 < list.size()) {
            ...
            zzki2.zzp(i10, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i11++;
        }
    }
    ...
    public final void zzD(int i10, List list, boolean z10) throws IOException {
        ...
        while (i11 < list.size()) {
            ...
            zzki2.zzr(i10, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i11++;
        }
    }
    ...
    public final void zzd(int i10, zzka zzka) throws IOException {
        this.zza.zze(i10, zzka);
    }
    ...
    public final void zzq(int i10, Object obj, zzmt zzmt) throws IOException {
        zzki zzki = this.zza;
        zzki.zzo(i10, 3);
    ...
    public final void zzv(int i10, Object obj, zzmt zzmt) throws IOException {
        zzmi zzmi = (zzmi) obj;
