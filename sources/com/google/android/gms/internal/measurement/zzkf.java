...
final class zzkf extends zzki {
    ...
    zzkf(byte[] bArr, int i10, int i11) {
        super((zzkh) null);
        if (bArr != null) {
    ...
    public final void zzb(byte b10) throws IOException {
        try {
            ...
            throw new zzkg(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1}), e10);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i10, int i11) throws IOException {
        try {
            ...
            throw new zzkg(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i11)}), e10);
        }
    }
    ...
    public final void zze(int i10, zzka zzka) throws IOException {
        zzq((i10 << 3) | 2);
        zzq(zzka.zzd());
        zzka.zzh(this);
    }
    ...
    public final void zzs(long j10) throws IOException {
        if (!zzki.zzd || this.zzd - this.zze < 10) {
            ...
            while ((j10 & -128) != 0) {
                ...
                int i12 = this.zze;
                this.zze = i12 + 1;
                zznu.zzn(bArr3, (long) i12, (byte) ((((int) j10) & Opcodes.LAND) | 128));
                j10 >>>= 7;
            }
            byte[] bArr4 = this.zzc;
            int i13 = this.zze;
            this.zze = i13 + 1;
            zznu.zzn(bArr4, (long) i13, (byte) ((int) j10));
        }
    }
}
