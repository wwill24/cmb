...
public enum RenderMode {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f8520a = null;
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.RenderMode.a.<clinit>():void");
        }
    }

    public boolean b(int i10, boolean z10, int i11) {
        int i12 = a.f8520a[ordinal()];
        if (i12 == 1) {
            return false;
        }
        if (i12 == 2) {
