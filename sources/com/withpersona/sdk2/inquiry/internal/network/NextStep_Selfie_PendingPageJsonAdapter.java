...
public final class NextStep_Selfie_PendingPageJsonAdapter extends h<NextStep.Selfie.PendingPage> {
    ...
    private final JsonReader.b f26876a;

    /* renamed from: b  reason: collision with root package name */
    private final h<String> f26877b;

    public NextStep_Selfie_PendingPageJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
    ...
    /* renamed from: a */
    public NextStep.Selfie.PendingPage fromJson(JsonReader jsonReader) {
        j.g(jsonReader, "reader");
        jsonReader.b();
        String str = null;
        String str2 = null;
        while (jsonReader.g()) {
            int L = jsonReader.L(this.f26876a);
            if (L == -1) {
                jsonReader.S();
                jsonReader.Y();
            } else if (L == 0) {
                str = this.f26877b.fromJson(jsonReader);
                if (str == null) {
                    JsonDataException x10 = c.x("title", "title", jsonReader);
                    j.f(x10, "unexpectedNull(\"title\", …tle\",\n            reader)");
                    throw x10;
                }
            } else if (L == 1 && (str2 = this.f26877b.fromJson(jsonReader)) == null) {
    ...
    /* renamed from: b */
    public void toJson(q qVar, NextStep.Selfie.PendingPage pendingPage) {
        j.g(qVar, "writer");
        if (pendingPage != null) {
            qVar.c();
            qVar.u("title");
            this.f26877b.toJson(qVar, pendingPage.c());
            qVar.u("description");
            this.f26877b.toJson(qVar, pendingPage.a());
            qVar.h();
            return;
        }
    ...
    public String toString() {
        ...
        sb2.append("NextStep.Selfie.PendingPage");
