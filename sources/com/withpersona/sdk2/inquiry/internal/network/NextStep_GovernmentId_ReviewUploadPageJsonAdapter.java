...
public final class NextStep_GovernmentId_ReviewUploadPageJsonAdapter extends h<NextStep.GovernmentId.ReviewUploadPage> {
    ...
    private final JsonReader.b f26855a;

    /* renamed from: b  reason: collision with root package name */
    private final h<String> f26856b;

    public NextStep_GovernmentId_ReviewUploadPageJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
        JsonReader.b a10 = JsonReader.b.a("titleFront", "titleBack", "titlePdf417", "titlePassportSignature", "descriptionFront", "descriptionBack", "descriptionPdf417", "descriptionPassportSignature", "confirmButtonText", "chooseAnotherButtonText");
        j.f(a10, "of(\"titleFront\", \"titleB…chooseAnotherButtonText\")");
        this.f26855a = a10;
    ...
    public com.withpersona.sdk2.inquiry.internal.network.NextStep.GovernmentId.ReviewUploadPage fromJson(com.squareup.moshi.JsonReader r24) {
        /*
            r23 = this;
            r0 = r23
            r1 = r24
        ...
        L_0x0017:
            boolean r2 = r24.g()
            java.lang.String r3 = "chooseAnotherButtonText"
            java.lang.String r14 = "confirmButtonText"
            ...
            com.squareup.moshi.JsonReader$b r2 = r0.f26855a
            int r2 = r1.L(r2)
            switch(r2) {
        ...
        L_0x0048:
            goto L_0x015d
        L_0x004a:
            com.squareup.moshi.h<java.lang.String> r2 = r0.f26856b
        ...
        L_0x0057:
            ...
            java.lang.String r2 = "unexpectedNull(\"chooseAn…otherButtonText\", reader)"
        ...
        L_0x0070:
            ...
            java.lang.String r2 = "unexpectedNull(\"confirmB…nfirmButtonText\", reader)"
            kotlin.jvm.internal.j.f(r1, r2)
            throw r1
        L_0x007a:
            com.squareup.moshi.h<java.lang.String> r2 = r0.f26856b
        ...
        L_0x016d:
            r24.e()
            com.withpersona.sdk2.inquiry.internal.network.NextStep$GovernmentId$ReviewUploadPage r2 = new com.withpersona.sdk2.inquiry.internal.network.NextStep$GovernmentId$ReviewUploadPage
        ...
        L_0x0199:
            ...
            java.lang.String r2 = "missingProperty(\"chooseA…otherButtonText\", reader)"
            kotlin.jvm.internal.j.f(r1, r2)
            throw r1
        L_0x01a3:
            com.squareup.moshi.JsonDataException r1 = bi.c.o(r14, r14, r1)
            java.lang.String r2 = "missingProperty(\"confirm…nfirmButtonText\", reader)"
            kotlin.jvm.internal.j.f(r1, r2)
            throw r1
        L_0x01ad:
        ...
        L_0x01f3:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.withpersona.sdk2.inquiry.internal.network.NextStep_GovernmentId_ReviewUploadPageJsonAdapter.fromJson(com.squareup.moshi.JsonReader):com.withpersona.sdk2.inquiry.internal.network.NextStep$GovernmentId$ReviewUploadPage");
    }

    /* renamed from: b */
    public void toJson(q qVar, NextStep.GovernmentId.ReviewUploadPage reviewUploadPage) {
        j.g(qVar, "writer");
        if (reviewUploadPage != null) {
            qVar.c();
            qVar.u("titleFront");
            this.f26856b.toJson(qVar, reviewUploadPage.k());
            qVar.u("titleBack");
            this.f26856b.toJson(qVar, reviewUploadPage.i());
            qVar.u("titlePdf417");
            this.f26856b.toJson(qVar, reviewUploadPage.m());
            qVar.u("titlePassportSignature");
            this.f26856b.toJson(qVar, reviewUploadPage.l());
            qVar.u("descriptionFront");
            this.f26856b.toJson(qVar, reviewUploadPage.f());
            qVar.u("descriptionBack");
            this.f26856b.toJson(qVar, reviewUploadPage.d());
            qVar.u("descriptionPdf417");
            this.f26856b.toJson(qVar, reviewUploadPage.h());
            qVar.u("descriptionPassportSignature");
            this.f26856b.toJson(qVar, reviewUploadPage.g());
            qVar.u("confirmButtonText");
            this.f26856b.toJson(qVar, reviewUploadPage.c());
            qVar.u("chooseAnotherButtonText");
            this.f26856b.toJson(qVar, reviewUploadPage.a());
            qVar.h();
            return;
        }
