...
final class ImagesKt$remoteImageFromUrl$3$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ UiComponent.RemoteImage $component;
    final /* synthetic */ f $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ImagesKt$remoteImageFromUrl$3$1(f fVar, UiComponent.RemoteImage remoteImage) {
        super(0);
