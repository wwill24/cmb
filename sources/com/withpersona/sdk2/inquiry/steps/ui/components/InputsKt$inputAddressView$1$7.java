...
final class InputsKt$inputAddressView$1$7 extends Lambda implements Function0<Unit> {
    final /* synthetic */ UiComponent.InputAddress $component;
    final /* synthetic */ c $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InputsKt$inputAddressView$1$7(UiComponent.InputAddress inputAddress, c cVar) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (G != null) {
            TextInputLayout textInputLayout = this.$this_apply.f24840f;
            j.f(textInputLayout, "addressPostalCode");
