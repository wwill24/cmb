...
final class InputsKt$inputDateView$1$1$5 extends Lambda implements Function0<Unit> {
    final /* synthetic */ UiComponent.InputDate $component;
    final /* synthetic */ e $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InputsKt$inputDateView$1$1$5(UiComponent.InputDate inputDate, e eVar) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (D != null && (i10 = D.i()) != null && (j10 = i10.j()) != null) {
            TextView textView = this.$this_apply.f24850d;
            j.f(textView, "errorLabel");
            m.e(textView, j10);
        }
    }
}
