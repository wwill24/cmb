...
final class InputsKt$inputDateView$1$1$7 extends Lambda implements Function0<Unit> {
    final /* synthetic */ UiComponent.InputDate $component;
    final /* synthetic */ e $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InputsKt$inputDateView$1$1$7(UiComponent.InputDate inputDate, e eVar) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (D != null && (j10 = D.j()) != null) {
            TextInputLayout textInputLayout = this.$this_apply.f24849c;
            j.f(textInputLayout, "day");
