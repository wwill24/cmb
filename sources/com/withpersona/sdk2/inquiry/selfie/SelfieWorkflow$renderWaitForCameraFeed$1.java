...
final class SelfieWorkflow$renderWaitForCameraFeed$1 extends Lambda implements Function1<PermissionRequestWorkflow.b, l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>> {
    ...
    SelfieWorkflow$renderWaitForCameraFeed$1(SelfieWorkflow selfieWorkflow, SelfieState.WaitForCameraFeed waitForCameraFeed, SelfieWorkflow.b bVar) {
        super(1);
        ...
        return Workflows__StatefulWorkflowKt.d(selfieWorkflow, (String) null, new Function1<l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>.c, Unit>() {
            public final void a(l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>.c cVar) {
                ...
                if (bVar.a().a() == PermissionResult.PermissionGranted) {
                    cVar.e(SelfieState.WaitForCameraFeed.i(waitForCameraFeed, true, false, 2, (Object) null));
                } else if (!bVar2.q()) {
