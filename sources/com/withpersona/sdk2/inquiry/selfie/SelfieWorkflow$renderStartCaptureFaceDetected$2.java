...
final class SelfieWorkflow$renderStartCaptureFaceDetected$2 extends Lambda implements Function1<Unit, l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>> {
    final /* synthetic */ SelfieState.StartCaptureFaceDetected $renderState;
    final /* synthetic */ SelfieWorkflow this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SelfieWorkflow$renderStartCaptureFaceDetected$2(SelfieWorkflow selfieWorkflow, SelfieState.StartCaptureFaceDetected startCaptureFaceDetected) {
        super(1);
    ...
    /* renamed from: a */
    public final l<SelfieWorkflow.b, SelfieState, SelfieWorkflow.c> invoke(Unit unit) {
        j.g(unit, "it");
        ...
        return Workflows__StatefulWorkflowKt.d(selfieWorkflow, (String) null, new Function1<l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>.c, Unit>() {
            public final void a(l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>.c cVar) {
                ...
                if (cVar.c() instanceof SelfieState.StartCaptureFaceDetected) {
                    cVar.e(new SelfieState.CountdownToCapture(3, (SelfieError) null, startCaptureFaceDetected.f(), startCaptureFaceDetected.d(), 2, (DefaultConstructorMarker) null));
                }
            }
