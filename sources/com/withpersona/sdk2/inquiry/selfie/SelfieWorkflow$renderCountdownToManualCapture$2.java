...
final class SelfieWorkflow$renderCountdownToManualCapture$2 extends Lambda implements Function1<String, Unit> {
    ...
    final /* synthetic */ SelfieState.CountdownToManualCapture $renderState;
    final /* synthetic */ SelfieWorkflow this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SelfieWorkflow$renderCountdownToManualCapture$2(Selfie.Direction direction, h<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c, ? extends Object>.a aVar, SelfieWorkflow selfieWorkflow, SelfieState.CountdownToManualCapture countdownToManualCapture, SelfieWorkflow.b bVar) {
        super(1);
        this.$direction = direction;
        this.$context = aVar;
        this.this$0 = selfieWorkflow;
        this.$renderState = countdownToManualCapture;
    ...
    public final void a(String str) {
        ...
        final SelfieState.CountdownToManualCapture countdownToManualCapture = this.$renderState;
        ...
        c10.d(Workflows__StatefulWorkflowKt.d(selfieWorkflow, (String) null, new Function1<l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>.c, Unit>() {
            public final void a(l<? super SelfieWorkflow.b, SelfieState, ? extends SelfieWorkflow.c>.c cVar) {
                ...
                cVar.e(selfieWorkflow.k(countdownToManualCapture, bVar, selfieImage));
            }
