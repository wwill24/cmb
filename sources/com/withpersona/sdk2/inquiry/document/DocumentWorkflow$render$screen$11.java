...
final class DocumentWorkflow$render$screen$11 extends Lambda implements Function1<PermissionRequestWorkflow.b, l<? super DocumentWorkflow.b, DocumentWorkflow.State, ? extends DocumentWorkflow.c>> {
    final /* synthetic */ DocumentWorkflow.State $renderState;
    final /* synthetic */ DocumentWorkflow this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DocumentWorkflow$render$screen$11(DocumentWorkflow documentWorkflow, DocumentWorkflow.State state) {
        super(1);
    ...
    public final l<DocumentWorkflow.b, DocumentWorkflow.State, DocumentWorkflow.c> invoke(final PermissionRequestWorkflow.b bVar) {
        ...
        return Workflows__StatefulWorkflowKt.d(documentWorkflow, (String) null, new Function1<l<? super DocumentWorkflow.b, DocumentWorkflow.State, ? extends DocumentWorkflow.c>.c, Unit>() {
            ...
            /* renamed from: com.withpersona.sdk2.inquiry.document.DocumentWorkflow$render$screen$11$1$a */
            public /* synthetic */ class a {
                ...
                static {
                    ...
                    L_0x0022:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.withpersona.sdk2.inquiry.document.DocumentWorkflow$render$screen$11.AnonymousClass1.a.<clinit>():void");
                }
            }
            ...
            public final void a(l<? super DocumentWorkflow.b, DocumentWorkflow.State, ? extends DocumentWorkflow.c>.c cVar) {
                ...
                int i10 = a.f25129a[bVar.a().a().ordinal()];
                if (i10 == 1) {
