...
public final class PassportNfcNfcNotSupportedView$special$$inlined$getViewFactoryForScreen$default$2 extends Lambda implements Function1<b, f<PassportNfcNfcNotSupportedView>> {
    ...
    public static final class a<RenderingT> implements f {
        ...
        final /* synthetic */ o f25952b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ b f25953c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ j f25954d;
        ...
        public final void a(RenderingT renderingt, p pVar) {
            ...
            oVar.g(bVar, renderingt, pVar, this.f25954d.c().a());
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PassportNfcNfcNotSupportedView$special$$inlined$getViewFactoryForScreen$default$2(UiScreen uiScreen, Function2 function2, o oVar) {
        super(1);
    ...
    /* renamed from: a */
    public final f<PassportNfcNfcNotSupportedView> invoke(b bVar) {
