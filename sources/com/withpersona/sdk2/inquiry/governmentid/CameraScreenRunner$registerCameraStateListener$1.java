...
@d(c = "com.withpersona.sdk2.inquiry.governmentid.CameraScreenRunner$registerCameraStateListener$1", f = "CameraScreenRunner.kt", l = {491}, m = "invokeSuspend")
final class CameraScreenRunner$registerCameraStateListener$1 extends SuspendLambda implements Function2<k0, c<? super Unit>, Object> {
    ...
    static final class a<T> implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ CameraScreenRunner f25292a;

        a(CameraScreenRunner cameraScreenRunner) {
            this.f25292a = cameraScreenRunner;
        }
        ...
        public final Object c(n nVar, c<? super Unit> cVar) {
            ...
            if (j.b(nVar, n.b.f14368a)) {
                Function1 n11 = this.f25292a.f25284i;
                if (n11 != null) {
                    n11.invoke(new UnsupportedDevice());
                }
            } else if ((nVar instanceof n.a) && ((n.a) nVar).a() && (n10 = this.f25292a.f25284i) != null) {
                n10.invoke(new RecordingInterrupted());
            }
            return Unit.f32013a;
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            g.b(obj);
            b<n> a10 = CameraControllerKt.a(this.this$0.f25278c.c());
