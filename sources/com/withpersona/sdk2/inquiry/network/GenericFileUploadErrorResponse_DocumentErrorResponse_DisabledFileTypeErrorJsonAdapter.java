...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_DisabledFileTypeErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_DisabledFileTypeErrorJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
        ...
        h<GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError.Details> f11 = sVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError.Details.class, n0.e(), ErrorBundle.DETAIL_ENTRY);
    ...
    public GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError fromJson(JsonReader jsonReader) {
    ...
    public void toJson(q qVar, GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError disabledFileTypeError) {
        j.g(qVar, "writer");
        if (disabledFileTypeError != null) {
            qVar.c();
            qVar.u("title");
            this.stringAdapter.toJson(qVar, disabledFileTypeError.getTitle());
            qVar.u("code");
            this.stringAdapter.toJson(qVar, disabledFileTypeError.getCode());
            qVar.u(ErrorBundle.DETAIL_ENTRY);
            this.detailsAdapter.toJson(qVar, disabledFileTypeError.getDetails());
            qVar.h();
            return;
        }
