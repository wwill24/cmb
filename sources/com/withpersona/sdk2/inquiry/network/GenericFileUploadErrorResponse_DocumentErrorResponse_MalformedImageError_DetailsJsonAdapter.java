...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedImageError_DetailsJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError.Details> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedImageError_DetailsJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
    ...
    public void toJson(q qVar, GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError.Details details) {
        j.g(qVar, "writer");
        if (details != null) {
            qVar.c();
            qVar.h();
