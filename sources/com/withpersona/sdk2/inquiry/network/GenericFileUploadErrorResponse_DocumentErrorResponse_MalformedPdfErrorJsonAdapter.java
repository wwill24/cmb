...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfErrorJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
        ...
        h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError.Details> f11 = sVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError.Details.class, n0.e(), ErrorBundle.DETAIL_ENTRY);
    ...
    public String toString() {
        ...
        sb2.append("GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError");
    ...
    public void toJson(q qVar, GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError malformedPdfError) {
        j.g(qVar, "writer");
        if (malformedPdfError != null) {
            qVar.c();
            qVar.u("title");
            this.stringAdapter.toJson(qVar, malformedPdfError.getTitle());
            qVar.u("code");
            this.stringAdapter.toJson(qVar, malformedPdfError.getCode());
            qVar.u(ErrorBundle.DETAIL_ENTRY);
            this.detailsAdapter.toJson(qVar, malformedPdfError.getDetails());
            qVar.h();
            return;
        }
