...
public final class InternalErrorInfo_ConfigurationErrorInfoJsonAdapter extends h<InternalErrorInfo.ConfigurationErrorInfo> {
    ...
    public InternalErrorInfo_ConfigurationErrorInfoJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
    ...
    public InternalErrorInfo.ConfigurationErrorInfo fromJson(JsonReader jsonReader) {
    ...
    public void toJson(q qVar, InternalErrorInfo.ConfigurationErrorInfo configurationErrorInfo) {
        j.g(qVar, "writer");
        if (configurationErrorInfo != null) {
            qVar.c();
            qVar.u("message");
            this.stringAdapter.toJson(qVar, configurationErrorInfo.getMessage());
            qVar.h();
            return;
        }
