...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_PageLimitExceededErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError> {
    private final h<GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError.Details> detailsAdapter;
    private final JsonReader.b options;
    private final h<String> stringAdapter;

    public GenericFileUploadErrorResponse_DocumentErrorResponse_PageLimitExceededErrorJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
        ...
        h<GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError.Details> f11 = sVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError.Details.class, n0.e(), ErrorBundle.DETAIL_ENTRY);
    ...
    public void toJson(q qVar, GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError pageLimitExceededError) {
        j.g(qVar, "writer");
        if (pageLimitExceededError != null) {
            qVar.c();
            qVar.u("title");
            this.stringAdapter.toJson(qVar, pageLimitExceededError.getTitle());
            qVar.u("code");
            this.stringAdapter.toJson(qVar, pageLimitExceededError.getCode());
            qVar.u(ErrorBundle.DETAIL_ENTRY);
            this.detailsAdapter.toJson(qVar, pageLimitExceededError.getDetails());
            qVar.h();
            return;
        }
