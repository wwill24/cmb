...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfError_DetailsJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError.Details> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfError_DetailsJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
    ...
    public void toJson(q qVar, GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError.Details details) {
        j.g(qVar, "writer");
        if (details != null) {
            qVar.c();
            qVar.h();
