...
public final class ErrorResponse_Error_FieldNotFoundErrorJsonAdapter extends h<ErrorResponse.Error.FieldNotFoundError> {
    ...
    public ErrorResponse_Error_FieldNotFoundErrorJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
    ...
    public String toString() {
        ...
        sb2.append("ErrorResponse.Error.FieldNotFoundError");
    ...
    public ErrorResponse.Error.FieldNotFoundError fromJson(JsonReader jsonReader) {
    ...
    public void toJson(q qVar, ErrorResponse.Error.FieldNotFoundError fieldNotFoundError) {
        j.g(qVar, "writer");
        if (fieldNotFoundError != null) {
            qVar.c();
            qVar.u("title");
            this.nullableStringAdapter.toJson(qVar, fieldNotFoundError.getTitle());
            qVar.u(ErrorBundle.DETAIL_ENTRY);
            this.nullableStringAdapter.toJson(qVar, fieldNotFoundError.getDetails());
            qVar.h();
            return;
        }
