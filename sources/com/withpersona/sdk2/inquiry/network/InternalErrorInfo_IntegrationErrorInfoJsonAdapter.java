...
public final class InternalErrorInfo_IntegrationErrorInfoJsonAdapter extends h<InternalErrorInfo.IntegrationErrorInfo> {
    ...
    public InternalErrorInfo_IntegrationErrorInfoJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
    ...
    public InternalErrorInfo.IntegrationErrorInfo fromJson(JsonReader jsonReader) {
    ...
    public void toJson(q qVar, InternalErrorInfo.IntegrationErrorInfo integrationErrorInfo) {
        j.g(qVar, "writer");
        if (integrationErrorInfo != null) {
            qVar.c();
            qVar.u("message");
            this.stringAdapter.toJson(qVar, integrationErrorInfo.getMessage());
            qVar.h();
            return;
        }
