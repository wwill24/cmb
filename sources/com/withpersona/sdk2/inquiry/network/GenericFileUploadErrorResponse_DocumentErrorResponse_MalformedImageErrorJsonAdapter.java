...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedImageErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedImageErrorJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
        ...
        h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError.Details> f11 = sVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError.Details.class, n0.e(), ErrorBundle.DETAIL_ENTRY);
    ...
    public GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError fromJson(JsonReader jsonReader) {
    ...
    public void toJson(q qVar, GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError malformedImageError) {
        j.g(qVar, "writer");
        if (malformedImageError != null) {
            qVar.c();
            qVar.u("title");
            this.stringAdapter.toJson(qVar, malformedImageError.getTitle());
            qVar.u("code");
            this.stringAdapter.toJson(qVar, malformedImageError.getCode());
            qVar.u(ErrorBundle.DETAIL_ENTRY);
            this.detailsAdapter.toJson(qVar, malformedImageError.getDetails());
            qVar.h();
            return;
        }
