...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError> {
    private final h<GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details> detailsAdapter;
    private final JsonReader.b options;
    private final h<String> stringAdapter;

    public GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededErrorJsonAdapter(s sVar) {
        j.g(sVar, "moshi");
        ...
        h<GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details> f11 = sVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details.class, n0.e(), ErrorBundle.DETAIL_ENTRY);
    ...
    public String toString() {
        ...
        sb2.append("GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError");
    ...
    public void toJson(q qVar, GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError fileLimitExceededError) {
        j.g(qVar, "writer");
        if (fileLimitExceededError != null) {
            qVar.c();
            qVar.u("title");
            this.stringAdapter.toJson(qVar, fileLimitExceededError.getTitle());
            qVar.u("code");
            this.stringAdapter.toJson(qVar, fileLimitExceededError.getCode());
            qVar.u(ErrorBundle.DETAIL_ENTRY);
            this.detailsAdapter.toJson(qVar, fileLimitExceededError.getDetails());
            qVar.h();
            return;
        }
