...
public class Constants {
    ...
    public static String LEANPLUM_VERSION = "7.0.1";
    ...
    public static class Crypt {
        ...
        public static final String IV = "__l3anplum__iv__";
        public static final int KEY_LENGTH = 256;
        public static final String SALT = "L3@nP1Vm";
    }
    ...
    public static class Defaults {
        ...
        public static final String MESSAGE_IMPRESSION_OCCURRENCES_KEY = "__leanplum_message_occurrences_%s";
        public static final String MESSAGE_MUTED_KEY = "__leanplum_message_muted_%s";
        public static final String MESSAGE_TRIGGER_OCCURRENCES_KEY = "__leanplum_message_trigger_occurrences_%s";
    ...
    static class Files {
        ...
        public static final int MAX_UPLOAD_BATCH_SIZES = 26214400;
    ...
    public static class Params {
        ...
        public static final String GOOGLE_PLAY_PURCHASE_DATA_SIGNATURE = "googlePlayPurchaseDataSignature";
