...
public final class ElementMatchers {
    ...
    public static <T extends ClassLoader> ElementMatcher.Junction<T> isExtensionClassLoader() {
        ...
        return new EqualityMatcher(parent);
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGetter() {
        return takesNoArguments().and(not(returns(TypeDescription.ForLoadedType.of(Void.TYPE)))).and(nameStartsWith("get").or(nameStartsWith("is").and(returnsGeneric((ElementMatcher<? super TypeDescription.Generic>) anyOf(Boolean.TYPE, Boolean.class)))));
    }
    ...
    public static <T extends ClassLoader> ElementMatcher.Junction<T> isParentOf(@MaybeNull ClassLoader classLoader) {
        ...
        return new ClassLoaderParentMatcher(classLoader);
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArgument(int i10, Class<?> cls) {
        return takesArgument(i10, TypeDescription.ForLoadedType.of(cls));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesGenericArgument(int i10, Type type) {
        return takesGenericArgument(i10, TypeDefinition.Sort.describe(type));
    }
    ...
    public static <T> ElementMatcher.Junction<T> cached(ElementMatcher<? super T> elementMatcher, int i10) {
        if (i10 >= 1) {
            return new CachingMatcher.WithInlineEviction(elementMatcher, new ConcurrentHashMap(), i10);
        }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> declaresException(TypeDescription typeDescription) {
        if (typeDescription.isAssignableTo((Class<?>) Throwable.class)) {
            return declaresGenericException((ElementMatcher<? super Iterable<? extends TypeDescription.Generic>>) new CollectionItemMatcher(erasure(typeDescription)));
        }
        return BooleanMatcher.of(false);
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> declaresGenericException(TypeDescription.Generic generic) {
        if (generic.getSort().isWildcard() || !generic.asErasure().isAssignableTo((Class<?>) Throwable.class)) {
            return BooleanMatcher.of(false);
        }
        return declaresGenericException((ElementMatcher<? super Iterable<? extends TypeDescription.Generic>>) new CollectionItemMatcher(is((Object) generic)));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArgument(int i10, TypeDescription typeDescription) {
        return takesArgument(i10, (ElementMatcher<? super TypeDescription>) is((Object) typeDescription));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesGenericArgument(int i10, TypeDescription.Generic generic) {
        return takesGenericArgument(i10, (ElementMatcher<? super TypeDescription.Generic>) is((Object) generic));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArgument(int i10, ElementMatcher<? super TypeDescription> elementMatcher) {
        return takesGenericArgument(i10, (ElementMatcher<? super TypeDescription.Generic>) erasure(elementMatcher));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesGenericArgument(int i10, ElementMatcher<? super TypeDescription.Generic> elementMatcher) {
        return takesGenericArguments((ElementMatcher<? super Iterable<? extends TypeDescription.Generic>>) new CollectionElementMatcher(i10, elementMatcher));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArguments(int i10) {
        return new MethodParametersMatcher(new CollectionSizeMatcher(i10));
    }
