...
public class TypeReference {
    ...
    public TypeReference(int i10) {
        this.targetTypeAndInfo = i10;
    }

    public static TypeReference newExceptionReference(int i10) {
        return new TypeReference((i10 << 8) | 385875968);
    }

    public static TypeReference newFormalParameterReference(int i10) {
        return new TypeReference((i10 << 16) | 369098752);
    }

    public static TypeReference newSuperTypeReference(int i10) {
        return new TypeReference(((i10 & 65535) << 8) | 268435456);
    }

    public static TypeReference newTryCatchReference(int i10) {
        return new TypeReference((i10 << 8) | 1107296256);
    }

    public static TypeReference newTypeArgumentReference(int i10, int i11) {
        return new TypeReference((i10 << 24) | i11);
    }

    public static TypeReference newTypeParameterBoundReference(int i10, int i11, int i12) {
        return new TypeReference((i10 << 24) | (i11 << 16) | (i12 << 8));
    }

    public static TypeReference newTypeParameterReference(int i10, int i11) {
        return new TypeReference((i10 << 24) | (i11 << 16));
    }

    public static TypeReference newTypeReference(int i10) {
        return new TypeReference(i10 << 24);
    }
