...
public enum Duplication implements StackManipulation {
    ...
    SINGLE(StackSize.SINGLE, 89) {
        public StackManipulation flipOver(TypeDefinition typeDefinition) {
            int i10 = AnonymousClass4.$SwitchMap$net$bytebuddy$implementation$bytecode$StackSize[typeDefinition.getStackSize().ordinal()];
            if (i10 == 1) {
    ...
    protected enum WithFlip implements StackManipulation {
        ...
        private WithFlip(int i10, StackSize stackSize2) {
            this.opcode = i10;
    ...
    private Duplication(StackSize stackSize, int i10) {
