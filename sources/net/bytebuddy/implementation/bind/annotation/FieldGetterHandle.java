...
public @interface FieldGetterHandle {
    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldGetterHandle> {
        ...
        protected static class Delegate extends TargetMethodAnnotationDrivenBinder.ParameterBinder.ForFieldBinding<FieldGetterHandle> {
            protected Delegate() {
            }
        ...
        private Binder(TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldGetterHandle> parameterBinder) {
