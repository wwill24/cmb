...
public final class a implements ag.a {
    ...
    private static final ThreadLocal<Cipher> f19000b = new C0230a();

    /* renamed from: a  reason: collision with root package name */
    private final SecretKey f19001a;

    /* renamed from: cg.a$a  reason: collision with other inner class name */
    class C0230a extends ThreadLocal<Cipher> {
        C0230a() {
        }
        ...
        public Cipher initialValue() {
            try {
                return m.f23528f.a("AES/GCM-SIV/NoPadding");
    ...
    public a(byte[] bArr) throws GeneralSecurityException {
        w.a(bArr.length);
        this.f19001a = new SecretKeySpec(bArr, "AES");
    }
    ...
    public byte[] a(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        if (bArr.length <= 2147483619) {
            ...
            ThreadLocal<Cipher> threadLocal = f19000b;
            threadLocal.get().init(1, this.f19001a, c11);
    ...
    public byte[] b(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        if (bArr.length >= 28) {
            ...
            ThreadLocal<Cipher> threadLocal = f19000b;
            threadLocal.get().init(2, this.f19001a, d10);
            if (!(bArr2 == null || bArr2.length == 0)) {
                threadLocal.get().updateAAD(bArr2);
            }
