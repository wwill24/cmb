...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final androidx.collection.a<String, Integer> f239c;

    /* renamed from: d  reason: collision with root package name */
    private static final String[] f240d = {"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};

    /* renamed from: e  reason: collision with root package name */
    private static final String[] f241e = {"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};

    /* renamed from: f  reason: collision with root package name */
    private static final String[] f242f = {"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f243a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
