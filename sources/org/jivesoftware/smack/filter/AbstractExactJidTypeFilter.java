...
public abstract class AbstractExactJidTypeFilter extends AbstractJidTypeFilter {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jivesoftware.smack.filter.AbstractExactJidTypeFilter.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public final boolean accept(Stanza stanza) {
        ...
        if (i10 == 1) {
            return jidToInspect.B0();
        }
        if (i10 == 2) {
            return jidToInspect.t0();
        }
        if (i10 == 3) {
            return jidToInspect.j1();
        }
        if (i10 == 4) {
