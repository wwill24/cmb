...
public class PubSubProvider extends IQProvider<PubSub> {
    ...
    /* renamed from: org.jivesoftware.smackx.pubsub.provider.PubSubProvider$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jivesoftware.smackx.pubsub.provider.PubSubProvider.AnonymousClass1.<clinit>():void");
        }
    }

    public PubSub parse(XmlPullParser xmlPullParser, int i10, XmlEnvironment xmlEnvironment) throws XmlPullParserException, IOException, SmackParsingException {
        ...
        while (true) {
            ...
            if (i11 == 1) {
                PacketParserUtils.addExtensionElement((Stanza) pubSub, xmlPullParser, xmlEnvironment);
