    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jivesoftware.smackx.blocking.provider.UnblockContactsIQProvider.AnonymousClass1.<clinit>():void");
        }
    }

    public UnblockContactsIQ parse(XmlPullParser xmlPullParser, int i10, XmlEnvironment xmlEnvironment) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (i11 != 1) {
                ...
                arrayList.add(a.o(xmlPullParser.getAttributeValue("", "jid")));
            }
        }
    }
}
