    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jivesoftware.smackx.address.provider.MultipleAddressesProvider.AnonymousClass1.<clinit>():void");
        }
    }

    public MultipleAddresses parse(XmlPullParser xmlPullParser, int i10, XmlEnvironment xmlEnvironment) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (i11 == 1) {
                ...
                if (name.equals("address")) {
                    multipleAddresses.addAddress(MultipleAddresses.Type.valueOf(xmlPullParser.getAttributeValue("", "type")), ParserUtils.getJidAttribute(xmlPullParser, "jid"), xmlPullParser.getAttributeValue("", NodeElement.ELEMENT), xmlPullParser.getAttributeValue("", "desc"), ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(xmlPullParser.getAttributeValue("", "delivered")), xmlPullParser.getAttributeValue("", "uri"));
                }
