...
public class MamPrefsIQProvider extends IQProvider<MamPrefsIQ> {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jivesoftware.smackx.mam.provider.MamPrefsIQProvider.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    private static List<Jid> iterateJids(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (i10 == 1) {
                ...
                if (name.equals("jid")) {
                    xmlPullParser.next();
                    arrayList.add(a.o(xmlPullParser.getText()));
                }
    ...
    public MamPrefsIQ parse(XmlPullParser xmlPullParser, int i10, XmlEnvironment xmlEnvironment) throws XmlPullParserException, IOException {
