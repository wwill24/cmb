...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    protected int[] f23915x;

    public SecP128R1FieldElement() {
        this.f23915x = Nat128.create();
    }
    ...
    public SecP128R1FieldElement(BigInteger bigInteger) {
        ...
        this.f23915x = SecP128R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP128R1Field.add(this.f23915x, ((SecP128R1FieldElement) eCFieldElement).f23915x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat128.create();
        SecP128R1Field.addOne(this.f23915x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.inv(((SecP128R1FieldElement) eCFieldElement).f23915x, create);
        SecP128R1Field.multiply(create, this.f23915x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat128.eq(this.f23915x, ((SecP128R1FieldElement) obj).f23915x);
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f23915x, 0, 4);
    }

    public ECFieldElement invert() {
        int[] create = Nat128.create();
        SecP128R1Field.inv(this.f23915x, create);
        return new SecP128R1FieldElement(create);
    }

    public boolean isOne() {
        return Nat128.isOne(this.f23915x);
    }

    public boolean isZero() {
        return Nat128.isZero(this.f23915x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.multiply(this.f23915x, ((SecP128R1FieldElement) eCFieldElement).f23915x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat128.create();
        SecP128R1Field.negate(this.f23915x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f23915x;
    ...
    public ECFieldElement square() {
        int[] create = Nat128.create();
        SecP128R1Field.square(this.f23915x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.subtract(this.f23915x, ((SecP128R1FieldElement) eCFieldElement).f23915x, create);
        return new SecP128R1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat128.getBit(this.f23915x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat128.toBigInteger(this.f23915x);
    }
}
