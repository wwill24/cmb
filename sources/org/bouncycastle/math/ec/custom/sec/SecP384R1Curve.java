...
public class SecP384R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f23933q = SecP384R1FieldElement.Q;
    protected SecP384R1Point infinity = new SecP384R1Point(this, (ECFieldElement) null, (ECFieldElement) null);

    public SecP384R1Curve() {
        super(f23933q);
        this.f23892a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFC")));
        this.f23893b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC656398D8A2ED19D2A85C8EDD3EC2AEF")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        final int[] iArr = new int[(i11 * 12 * 2)];
        int i12 = 0;
        for (int i13 = 0; i13 < i11; i13++) {
            ECPoint eCPoint = eCPointArr[i10 + i13];
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawXCoord()).f23934x, 0, iArr, i12);
            int i14 = i12 + 12;
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawYCoord()).f23934x, 0, iArr, i14);
            i12 = i14 + 12;
        }
            ...
            public ECPoint lookup(int i10) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    ...
                    for (int i14 = 0; i14 < 12; i14++) {
                        ...
                        create2[i14] = create2[i14] ^ (iArr[(i11 + 12) + i14] & i13);
                    }
                    i11 += 24;
                }
