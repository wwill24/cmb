...
public class SecP256K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    protected int[] f23930x;

    public SecP256K1FieldElement() {
        this.f23930x = Nat256.create();
    }
    ...
    public SecP256K1FieldElement(BigInteger bigInteger) {
        ...
        this.f23930x = SecP256K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP256K1Field.add(this.f23930x, ((SecP256K1FieldElement) eCFieldElement).f23930x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        SecP256K1Field.addOne(this.f23930x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.inv(((SecP256K1FieldElement) eCFieldElement).f23930x, create);
        SecP256K1Field.multiply(create, this.f23930x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat256.eq(this.f23930x, ((SecP256K1FieldElement) obj).f23930x);
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f23930x, 0, 8);
    }

    public ECFieldElement invert() {
        int[] create = Nat256.create();
        SecP256K1Field.inv(this.f23930x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat256.isOne(this.f23930x);
    }

    public boolean isZero() {
        return Nat256.isZero(this.f23930x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.multiply(this.f23930x, ((SecP256K1FieldElement) eCFieldElement).f23930x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat256.create();
        SecP256K1Field.negate(this.f23930x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f23930x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        SecP256K1Field.square(this.f23930x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.subtract(this.f23930x, ((SecP256K1FieldElement) eCFieldElement).f23930x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat256.getBit(this.f23930x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f23930x);
    }
}
