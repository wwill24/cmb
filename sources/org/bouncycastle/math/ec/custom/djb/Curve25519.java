...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f23910q = Curve25519FieldElement.Q;
    ...
    public Curve25519() {
        super(f23910q);
        this.f23892a = fromBigInteger(C_a);
        this.f23893b = fromBigInteger(C_b);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        ...
        for (int i13 = 0; i13 < i11; i13++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f23911x, 0, iArr, i12);
            int i14 = i12 + 8;
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f23911x, 0, iArr, i14);
            i12 = i14 + 8;
        }
