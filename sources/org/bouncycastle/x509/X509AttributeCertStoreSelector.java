                    ...
                    for (Targets targets : targetsObjects) {
                        ...
                        while (true) {
                            if (i10 >= targets2.length) {
                                break;
                            } else if (this.targetNames.contains(GeneralName.getInstance(targets2[i10].getTargetName()))) {
                                z10 = true;
                                break;
                            } else {
                                i10++;
                    ...
                    for (Targets targets3 : targetsObjects) {
                        ...
                        while (true) {
                            if (i11 >= targets4.length) {
                                break;
                            } else if (this.targetGroups.contains(GeneralName.getInstance(targets4[i11].getTargetGroup()))) {
                                z11 = true;
                                break;
                            } else {
                                i11++;
