...
public class LDAPStoreHelper {
    ...
    private java.util.List search(java.lang.String[] r10, java.lang.String r11, java.lang.String[] r12) throws org.bouncycastle.util.StoreException {
        ...
        L_0x00a8:
            ...
            r10.<init>()
            javax.naming.directory.DirContext r3 = r9.connectLDAP()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            javax.naming.directory.SearchControls r0 = new javax.naming.directory.SearchControls     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            r0.<init>()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            r1 = 2
            r0.setSearchScope(r1)     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            r1 = 0
            r0.setCountLimit(r1)     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            r0.setReturningAttributes(r12)     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            org.bouncycastle.jce.X509LDAPCertStoreParameters r12 = r9.params     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            java.lang.String r12 = r12.getBaseDN()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            javax.naming.NamingEnumeration r12 = r3.search(r12, r11, r0)     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
        L_0x00cc:
            boolean r0 = r12.hasMoreElements()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            if (r0 == 0) goto L_0x00f8
            java.lang.Object r0 = r12.next()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            javax.naming.directory.SearchResult r0 = (javax.naming.directory.SearchResult) r0     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            javax.naming.directory.Attributes r0 = r0.getAttributes()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            javax.naming.NamingEnumeration r0 = r0.getAll()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            java.lang.Object r0 = r0.next()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            javax.naming.directory.Attribute r0 = (javax.naming.directory.Attribute) r0     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            javax.naming.NamingEnumeration r0 = r0.getAll()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
        L_0x00ea:
            boolean r1 = r0.hasMore()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            if (r1 == 0) goto L_0x00cc
            java.lang.Object r1 = r0.next()     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            r10.add(r1)     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
            goto L_0x00ea
        L_0x00f8:
            r9.addToCache(r11, r10)     // Catch:{ NamingException -> 0x0106, all -> 0x00ff }
        L_0x00fb:
