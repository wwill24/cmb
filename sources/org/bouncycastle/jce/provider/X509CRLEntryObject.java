...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f23870c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f23870c.equals(((X509CRLEntryObject) obj).f23870c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f23870c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f23870c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f23870c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f23870c.getExtensions() != null;
    }
