            ...
            if (instance == null) {
                ...
                if (instance2.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
                    try {
                        ...
                        if (z10 || validatedOcspResponse(instance3, this.parameters, bArr, this.parent.getOcspResponderCert(), this.helper)) {
                            ...
                            for (int i11 = 0; i11 != responses.size(); i11++) {
                                SingleResponse instance4 = SingleResponse.getInstance(responses.getObjectAt(i11));
