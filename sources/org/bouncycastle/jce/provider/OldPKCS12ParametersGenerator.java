...
class OldPKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    private byte[] generateDerivedKey(int i10, int i11) {
        ...
        int i22 = this.f23869v;
        byte[] bArr10 = new byte[i22];
        int i23 = this.f23868u;
        int i24 = ((i13 + i23) - 1) / i23;
        int i25 = 1;
        while (i25 <= i24) {
            int i26 = this.f23868u;
            ...
            for (int i27 = i17; i27 != this.iterationCount; i27++) {
                this.digest.update(bArr11, i15, i26);
                this.digest.doFinal(bArr11, i15);
            }
            for (int i28 = i15; i28 != i22; i28++) {
                bArr10[i25] = bArr11[i28 % i26];
            }
            int i29 = i15;
            while (true) {
                int i30 = this.f23869v;
                if (i29 == length3 / i30) {
                    break;
                }
                adjust(bArr9, i30 * i29, bArr10);
                i29++;
            }
            if (i25 == i24) {
                int i31 = i25 - 1;
                int i32 = this.f23868u;
                i12 = 0;
                System.arraycopy(bArr11, 0, bArr4, i31 * i32, i13 - (i31 * i32));
            } else {
                i12 = 0;
                System.arraycopy(bArr11, 0, bArr4, (i25 - 1) * this.f23868u, i26);
            }
            i25++;
            i15 = i12;
            i17 = 1;
