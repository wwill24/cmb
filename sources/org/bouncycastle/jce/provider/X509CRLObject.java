...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f23871c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (this.f23871c.getSignatureAlgorithm().equals(this.f23871c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z10) {
        ...
        if (getVersion() != 2 || (extensions = this.f23871c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f23871c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.isHashCodeSet || !x509CRLObject.isHashCodeSet || x509CRLObject.hashCodeValue == this.hashCodeValue) {
            return this.f23871c.equals(x509CRLObject.f23871c);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f23871c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f23871c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f23871c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f23871c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f23871c.getNextUpdate() != null) {
            return this.f23871c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f23871c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f23871c.getSignature().getOctets();
    }

    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f23871c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e10) {
            throw new CRLException(e10.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f23871c.getThisUpdate().getDate();
    }

    public int getVersion() {
        return this.f23871c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f23871c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f23871c.getIssuer();
