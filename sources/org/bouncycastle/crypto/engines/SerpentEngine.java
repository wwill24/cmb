...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        this.X0 = this.wKey[128] ^ Pack.littleEndianToInt(bArr, i10);
        this.X1 = this.wKey[129] ^ Pack.littleEndianToInt(bArr, i10 + 4);
        this.X2 = this.wKey[130] ^ Pack.littleEndianToInt(bArr, i10 + 8);
        ...
        this.X0 = i42 ^ iArr31[4];
        this.X1 ^= iArr31[5];
        this.X2 ^= iArr31[6];
        this.X3 ^= iArr31[7];
        inverseLT();
        ib0(this.X0, this.X1, this.X2, this.X3);
        Pack.intToLittleEndian(this.X0 ^ this.wKey[0], bArr2, i11);
        Pack.intToLittleEndian(this.X1 ^ this.wKey[1], bArr2, i11 + 4);
        Pack.intToLittleEndian(this.X2 ^ this.wKey[2], bArr2, i11 + 8);
        Pack.intToLittleEndian(this.X3 ^ this.wKey[3], bArr2, i11 + 12);
    }

    /* access modifiers changed from: protected */
    public void encryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        this.X0 = Pack.littleEndianToInt(bArr, i10);
        this.X1 = Pack.littleEndianToInt(bArr, i10 + 4);
        this.X2 = Pack.littleEndianToInt(bArr, i10 + 8);
        ...
        Pack.intToLittleEndian(this.wKey[128] ^ this.X0, bArr2, i11);
        Pack.intToLittleEndian(this.wKey[129] ^ this.X1, bArr2, i11 + 4);
        Pack.intToLittleEndian(this.wKey[130] ^ this.X2, bArr2, i11 + 8);
        Pack.intToLittleEndian(this.wKey[131] ^ this.X3, bArr2, i11 + 12);
    }
