...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        this.X3 = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i10);
        this.X2 = this.wKey[130] ^ Pack.bigEndianToInt(bArr, i10 + 4);
        this.X1 = this.wKey[129] ^ Pack.bigEndianToInt(bArr, i10 + 8);
        ...
        inverseLT();
        ib0(this.X0, this.X1, this.X2, this.X3);
        Pack.intToBigEndian(this.X3 ^ this.wKey[3], bArr2, i11);
        Pack.intToBigEndian(this.X2 ^ this.wKey[2], bArr2, i11 + 4);
        Pack.intToBigEndian(this.X1 ^ this.wKey[1], bArr2, i11 + 8);
        Pack.intToBigEndian(this.X0 ^ this.wKey[0], bArr2, i11 + 12);
    }

    /* access modifiers changed from: protected */
    public void encryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        this.X3 = Pack.bigEndianToInt(bArr, i10);
        this.X2 = Pack.bigEndianToInt(bArr, i10 + 4);
        this.X1 = Pack.bigEndianToInt(bArr, i10 + 8);
        ...
        Pack.intToBigEndian(this.wKey[131] ^ this.X3, bArr2, i11);
        Pack.intToBigEndian(this.wKey[130] ^ this.X2, bArr2, i11 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ this.X1, bArr2, i11 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ this.X0, bArr2, i11 + 12);
    }
