...
public class PublicKeyFactory {
    ...
    private static class DHAgreementConverter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) throws IOException {
            ...
            BigInteger l10 = instance.getL();
            return new DHPublicKeyParameters(aSN1Integer.getValue(), new DHParameters(instance.getP(), instance.getG(), (BigInteger) null, l10 == null ? 0 : l10.intValue()));
        }
    }
    ...
    private static class DHPublicNumberConverter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) throws IOException {
            ...
            BigInteger p10 = instance.getP();
            BigInteger g10 = instance.getG();
            BigInteger q10 = instance.getQ();
            DHValidationParameters dHValidationParameters = null;
            BigInteger j10 = instance.getJ() != null ? instance.getJ() : null;
            ...
            return new DHPublicKeyParameters(y10, new DHParameters(p10, g10, q10, j10, dHValidationParameters));
        }
    }
