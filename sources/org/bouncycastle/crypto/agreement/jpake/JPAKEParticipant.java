...
public class JPAKEParticipant {
    ...
    private final BigInteger f41357g;
    ...
    private final BigInteger f41358p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q  reason: collision with root package name */
    private final BigInteger f41359q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1  reason: collision with root package name */
    private BigInteger f41360x1;

    /* renamed from: x2  reason: collision with root package name */
    private BigInteger f41361x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest2, SecureRandom secureRandom) {
        ...
        JPAKEUtil.validateNotNull(jPAKEPrimeOrderGroup, XHTMLText.P);
        JPAKEUtil.validateNotNull(digest2, "digest");
        JPAKEUtil.validateNotNull(secureRandom, "random");
        if (cArr.length != 0) {
            this.participantId = str;
            this.password = Arrays.copyOf(cArr, cArr.length);
            this.f41358p = jPAKEPrimeOrderGroup.getP();
            this.f41359q = jPAKEPrimeOrderGroup.getQ();
            this.f41357g = jPAKEPrimeOrderGroup.getG();
            this.digest = digest2;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i10 >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f41358p, this.f41359q, this.gx4, this.f41361x2, calculateS, this.f41356b);
            this.f41360x1 = null;
            this.f41361x2 = null;
            this.f41356b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        if (this.state < 10) {
            this.f41360x1 = JPAKEUtil.generateX1(this.f41359q, this.random);
            this.f41361x2 = JPAKEUtil.generateX2(this.f41359q, this.random);
            this.gx1 = JPAKEUtil.calculateGx(this.f41358p, this.f41357g, this.f41360x1);
            this.gx2 = JPAKEUtil.calculateGx(this.f41358p, this.f41357g, this.f41361x2);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f41358p, this.f41359q, this.f41357g, this.gx1, this.f41360x1, this.participantId, this.digest, this.random);
            BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f41358p, this.f41359q, this.f41357g, this.gx2, this.f41361x2, this.participantId, this.digest, this.random);
            this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i10 >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f41358p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f41359q, this.f41361x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f41358p, this.f41359q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f41358p, this.f41359q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        if (this.state < 20) {
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f41358p, this.f41359q, this.f41357g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
            JPAKEUtil.validateZeroKnowledgeProof(this.f41358p, this.f41359q, this.f41357g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
            this.state = 20;
            return;
        }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i10 >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f41358p, this.gx3, this.gx1, this.gx2);
            this.f41356b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f41358p, this.f41359q, calculateGA, this.f41356b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        } else {
