...
public class SM2KeyExchange {
    ...
    private BigInteger reduce(BigInteger bigInteger) {
        return bigInteger.and(BigInteger.valueOf(1).shiftLeft(this.f41355w).subtract(BigInteger.valueOf(1))).setBit(this.f41355w);
    }
    ...
    public byte[][] calculateKeyWithConfirmation(int i10, byte[] bArr, CipherParameters cipherParameters) {
        ...
        if (!this.initiator || bArr3 != null) {
            ...
            ECPoint calculateU = calculateU(sM2KeyExchangePublicParameters);
            if (this.initiator) {
                byte[] kdf = kdf(calculateU, z10, z11, i11);
                byte[] calculateInnerHash = calculateInnerHash(this.digest, calculateU, z10, z11, this.ephemeralPubPoint, sM2KeyExchangePublicParameters.getEphemeralPublicKey().getQ());
            ...
            byte[] kdf2 = kdf(calculateU, z11, z10, i11);
            byte[] calculateInnerHash2 = calculateInnerHash(this.digest, calculateU, z11, z10, sM2KeyExchangePublicParameters.getEphemeralPublicKey().getQ(), this.ephemeralPubPoint);
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f41355w = (this.ecParams.getCurve().getFieldSize() / 2) - 1;
    }
}
