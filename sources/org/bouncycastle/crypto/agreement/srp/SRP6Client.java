...
public class SRP6Client {
    ...
    protected BigInteger f41372a;
    protected Digest digest;

    /* renamed from: g  reason: collision with root package name */
    protected BigInteger f41373g;
    protected SecureRandom random;

    /* renamed from: u  reason: collision with root package name */
    protected BigInteger f41374u;

    /* renamed from: x  reason: collision with root package name */
    protected BigInteger f41375x;

    private BigInteger calculateS() {
        BigInteger calculateK = SRP6Util.calculateK(this.digest, this.N, this.f41373g);
        return this.B.subtract(this.f41373g.modPow(this.f41375x, this.N).multiply(calculateK).mod(this.N)).mod(this.N).modPow(this.f41374u.multiply(this.f41375x).add(this.f41372a), this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f41374u = SRP6Util.calculateU(this.digest, this.N, this.A, validatePublicValue);
    ...
    public BigInteger generateClientCredentials(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        this.f41375x = SRP6Util.calculateX(this.digest, this.N, bArr, bArr2, bArr3);
        BigInteger selectPrivateValue = selectPrivateValue();
        this.f41372a = selectPrivateValue;
        BigInteger modPow = this.f41373g.modPow(selectPrivateValue, this.N);
        this.A = modPow;
        return modPow;
    }
    ...
    public BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f41373g, this.random);
    }
