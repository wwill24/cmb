...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    public int doFinal(byte[] bArr, int i10) {
        ...
        unpackWord(this.H8, bArr, i10 + 32);
        unpackWord(this.H9, bArr, i10 + 36);
        reset();
        return 40;
    }
    ...
    public void processBlock() {
        ...
        int i18 = this.H8;
        int i19 = this.H9;
        int RL = RL(i10 + f1(i11, i12, i13) + this.X[0], 11) + i14;
        int RL2 = RL(i12, 10);
        int RL3 = RL(i14 + f1(RL, i11, RL2) + this.X[1], 14) + i13;
        int RL4 = RL(i11, 10);
        int RL5 = RL(i13 + f1(RL3, RL, RL4) + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i15 + f5(i16, i17, i18) + this.X[5] + 1352829926, 8) + i19;
        int RL34 = RL(i17, 10);
        int RL35 = RL(i19 + f5(RL33, i16, RL34) + this.X[14] + 1352829926, 9) + i18;
        int RL36 = RL(i16, 10);
        int RL37 = RL(i18 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
