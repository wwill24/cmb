...
public class MD5Digest extends GeneralDigest implements EncodableDigest {
    ...
    public MD5Digest(byte[] bArr) {
        ...
        for (int i10 = 0; i10 != this.xOff; i10++) {
            this.X[i10] = Pack.bigEndianToInt(bArr, (i10 * 4) + 36);
        }
    }
    ...
    public byte[] getEncodedState() {
        ...
        for (int i10 = 0; i10 != this.xOff; i10++) {
            Pack.intToBigEndian(this.X[i10], bArr, (i10 * 4) + 36);
        }
        return bArr;
    }
    ...
    public void processBlock() {
        ...
        int i12 = this.H3;
        int i13 = this.H4;
        int rotateLeft = rotateLeft(((i10 + F(i11, i12, i13)) + this.X[0]) - 680876936, 7) + i11;
        int rotateLeft2 = rotateLeft(((i13 + F(rotateLeft, i11, i12)) + this.X[1]) - 389564586, 12) + rotateLeft;
        int rotateLeft3 = rotateLeft(i12 + F(rotateLeft2, rotateLeft, i11) + this.X[2] + 606105819, 17) + rotateLeft2;
        int rotateLeft4 = rotateLeft(((i11 + F(rotateLeft3, rotateLeft2, rotateLeft)) + this.X[3]) - 1044525330, 22) + rotateLeft3;
