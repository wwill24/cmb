...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        printStream2.println("q (" + q10.bitLength() + " bits): " + q10.toString(16));
        PrintStream printStream3 = System.out;
        printStream3.println("g (" + p10.bitLength() + " bits): " + g10.toString(16));
        ...
        printStream5.println("g^{q} mod p = " + g10.modPow(q10, p10).toString(16));
        System.out.println("");
