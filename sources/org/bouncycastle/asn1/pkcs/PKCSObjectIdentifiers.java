...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        rsaEncryption = aSN1ObjectIdentifier.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        md2WithRSAEncryption = aSN1ObjectIdentifier.branch("2");
        md4WithRSAEncryption = aSN1ObjectIdentifier.branch("3");
        md5WithRSAEncryption = aSN1ObjectIdentifier.branch(ReportMetadata.ID_TIPS);
        ...
        dhKeyAgreement = aSN1ObjectIdentifier2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier aSN1ObjectIdentifier3 = new ASN1ObjectIdentifier("1.2.840.113549.1.5");
        pkcs_5 = aSN1ObjectIdentifier3;
        pbeWithMD2AndDES_CBC = aSN1ObjectIdentifier3.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        pbeWithMD2AndRC2_CBC = aSN1ObjectIdentifier3.branch(ReportMetadata.ID_TIPS);
        ...
        rc4 = aSN1ObjectIdentifier4.branch(ReportMetadata.ID_TIPS);
        ...
        md4 = aSN1ObjectIdentifier5.branch(ReportMetadata.ID_TIPS);
        ...
        pkcs_9_at_emailAddress = aSN1ObjectIdentifier6.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES).intern();
        ...
        pkcs_9_at_messageDigest = aSN1ObjectIdentifier6.branch(ReportMetadata.ID_TIPS).intern();
        ...
        certTypes = branch;
        x509Certificate = branch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES).intern();
        sdsiCertificate = branch.branch("2").intern();
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier6.branch("23");
        crlTypes = branch2;
        x509Crl = branch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES).intern();
        ...
        id_ct_TSTInfo = aSN1ObjectIdentifier7.branch(ReportMetadata.ID_TIPS);
        ...
        id_cti_ets_proofOfOrigin = aSN1ObjectIdentifier8.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_cti_ets_proofOfReceipt = aSN1ObjectIdentifier8.branch("2");
        id_cti_ets_proofOfDelivery = aSN1ObjectIdentifier8.branch("3");
        id_cti_ets_proofOfSender = aSN1ObjectIdentifier8.branch(ReportMetadata.ID_TIPS);
        ...
        id_aa_receiptRequest = aSN1ObjectIdentifier9.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_aa_contentHint = aSN1ObjectIdentifier9.branch(ReportMetadata.ID_TIPS);
        ...
        bagtypes = branch8;
        keyBag = branch8.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        pkcs8ShroudedKeyBag = branch8.branch("2");
        certBag = branch8.branch("3");
        crlBag = branch8.branch(ReportMetadata.ID_TIPS);
        secretBag = branch8.branch("5");
        safeContentsBag = branch8.branch("6");
        ASN1ObjectIdentifier branch9 = aSN1ObjectIdentifier10.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        pkcs_12PbeIds = branch9;
        pbeWithSHAAnd128BitRC4 = branch9.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        pbeWithSHAAnd40BitRC4 = branch9.branch("2");
        pbeWithSHAAnd3_KeyTripleDES_CBC = branch9.branch("3");
        pbeWithSHAAnd2_KeyTripleDES_CBC = branch9.branch(ReportMetadata.ID_TIPS);
