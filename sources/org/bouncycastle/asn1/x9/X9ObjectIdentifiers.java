...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        id_fieldType = branch;
        prime_field = branch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        ASN1ObjectIdentifier branch3 = aSN1ObjectIdentifier.branch(ReportMetadata.ID_TIPS);
        id_ecSigType = branch3;
        ecdsa_with_SHA1 = branch3.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier branch4 = aSN1ObjectIdentifier.branch("2");
        id_publicKeyType = branch4;
        id_ecPublicKey = branch4.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier branch5 = branch3.branch("3");
        ecdsa_with_SHA2 = branch5;
        ecdsa_with_SHA224 = branch5.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ecdsa_with_SHA256 = branch5.branch("2");
        ecdsa_with_SHA384 = branch5.branch("3");
        ecdsa_with_SHA512 = branch5.branch(ReportMetadata.ID_TIPS);
        ...
        cTwoCurve = branch7;
        c2pnb163v1 = branch7.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        c2pnb163v2 = branch7.branch("2");
        c2pnb163v3 = branch7.branch("3");
        c2pnb176w1 = branch7.branch(ReportMetadata.ID_TIPS);
        ...
        ASN1ObjectIdentifier branch8 = branch6.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        primeCurve = branch8;
        prime192v1 = branch8.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        prime192v2 = branch8.branch("2");
        prime192v3 = branch8.branch("3");
        prime239v1 = branch8.branch(ReportMetadata.ID_TIPS);
        ...
        dhStatic = branch9.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        dhEphem = branch9.branch("2");
        dhOneFlow = branch9.branch("3");
        dhHybrid1 = branch9.branch(ReportMetadata.ID_TIPS);
        ...
        ASN1ObjectIdentifier branch10 = aSN1ObjectIdentifier4.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        x9_44_components = branch10;
        id_kdf_kdf2 = branch10.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
