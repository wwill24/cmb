...
public interface NISTObjectIdentifiers {
    ...
    static {
        ...
        hashAlgs = branch;
        id_sha256 = branch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_sha384 = branch.branch("2");
        id_sha512 = branch.branch("3");
        id_sha224 = branch.branch(ReportMetadata.ID_TIPS);
        ...
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        aes = branch2;
        id_aes128_ECB = branch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_aes128_CBC = branch2.branch("2");
        id_aes128_OFB = branch2.branch("3");
        id_aes128_CFB = branch2.branch(ReportMetadata.ID_TIPS);
        ...
        dsa_with_sha224 = branch3.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        dsa_with_sha256 = branch3.branch("2");
        dsa_with_sha384 = branch3.branch("3");
        dsa_with_sha512 = branch3.branch(ReportMetadata.ID_TIPS);
