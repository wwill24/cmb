...
public class KeyPurposeId extends ASN1Object {
    ...
    private ASN1ObjectIdentifier f16878id;

    static {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.3.6.1.5.5.7.3");
        id_kp = aSN1ObjectIdentifier;
        id_kp_serverAuth = new KeyPurposeId(aSN1ObjectIdentifier.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES));
        ...
        id_kp_emailProtection = new KeyPurposeId(aSN1ObjectIdentifier.branch(ReportMetadata.ID_TIPS));
    ...
    private KeyPurposeId(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.f16878id = aSN1ObjectIdentifier;
    }
