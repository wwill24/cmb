...
public class X509Name extends ASN1Object {
    ...
    static {
        ...
        hashtable9.put(ReportingMessage.MessageType.OPT_OUT, aSN1ObjectIdentifier56);
        ...
        hashtable9.put(UserDataStore.STATE, aSN1ObjectIdentifier9);
        ...
        hashtable9.put(ReportingMessage.MessageType.EVENT, aSN1ObjectIdentifier61);
        ...
        hashtable9.put(ProfileConstants.Field.GENDER, aSN1ObjectIdentifier28);
    ...
    public X509Name(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            int i10 = 0;
            while (true) {
                if (i10 < instance.size()) {
                    ASN1Sequence instance2 = ASN1Sequence.getInstance(instance.getObjectAt(i10).toASN1Primitive());
                    if (instance2.size() == 2) {
    ...
    private void appendValue(StringBuffer stringBuffer, Hashtable hashtable, ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        while (i10 < length2 && stringBuffer.charAt(i10) == ' ') {
        ...
        while (true) {
            length2--;
            if (length2 > i10 && stringBuffer.charAt(length2) == ' ') {
            ...
            while (i11 != i12) {
                ...
                while (true) {
                    if (i13 >= size) {
                        z10 = false;
                        break;
                    } else if (!zArr[i13] && aSN1ObjectIdentifier.equals((ASN1Primitive) (ASN1ObjectIdentifier) instance.ordering.elementAt(i13)) && equivalentStrings(str, (String) instance.values.elementAt(i13))) {
                        zArr[i13] = true;
                        z10 = true;
                        break;
                    } else {
    ...
    public boolean equals(Object obj, boolean z10) {
        ...
        try {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                if (!((ASN1ObjectIdentifier) this.ordering.elementAt(i10)).equals((ASN1Primitive) (ASN1ObjectIdentifier) instance.ordering.elementAt(i10)) || !equivalentStrings((String) this.values.elementAt(i10), (String) instance.values.elementAt(i10))) {
                    return false;
                }
            }
            return true;
