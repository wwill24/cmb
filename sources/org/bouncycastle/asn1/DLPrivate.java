...
public class DLPrivate extends ASN1Private {
    public DLPrivate(int i10, ASN1Encodable aSN1Encodable) throws IOException {
        this(true, i10, aSN1Encodable);
    }

    public DLPrivate(int i10, ASN1EncodableVector aSN1EncodableVector) {
        super(true, i10, getEncodedVector(aSN1EncodableVector));
    }

    public DLPrivate(int i10, byte[] bArr) {
        this(false, i10, bArr);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DLPrivate(boolean z10, int i10, ASN1Encodable aSN1Encodable) throws IOException {
        super(z10 || aSN1Encodable.toASN1Primitive().isConstructed(), i10, getEncoding(z10, aSN1Encodable));
    }

    DLPrivate(boolean z10, int i10, byte[] bArr) {
        super(z10, i10, bArr);
    }
