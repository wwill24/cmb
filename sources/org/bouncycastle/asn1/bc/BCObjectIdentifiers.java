...
public interface BCObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier f16845bc;
    ...
    static {
        ...
        f16845bc = aSN1ObjectIdentifier;
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        bc_pbe = branch;
        ASN1ObjectIdentifier branch2 = branch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        bc_pbe_sha1 = branch2;
        ...
        bc_pbe_sha1_pkcs5 = branch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier branch4 = branch2.branch("2");
        bc_pbe_sha1_pkcs12 = branch4;
        bc_pbe_sha256_pkcs5 = branch3.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        bc_sig = branch6;
        ASN1ObjectIdentifier branch7 = branch6.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        sphincs256 = branch7;
        sphincs256_with_BLAKE512 = branch7.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        xmss = branch8;
        ASN1ObjectIdentifier branch9 = branch8.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        ASN1ObjectIdentifier branch12 = branch8.branch(ReportMetadata.ID_TIPS);
        ...
        xmss_mt = branch13;
        ASN1ObjectIdentifier branch14 = branch13.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        xmss_mt_SHAKE256ph = branch13.branch(ReportMetadata.ID_TIPS);
        ...
        ASN1ObjectIdentifier branch18 = branch6.branch(ReportMetadata.ID_TIPS);
        qTESLA = branch18;
        qTESLA_Rnd1_I = branch18.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        qTESLA_Rnd1_III_size = branch18.branch("2");
        qTESLA_Rnd1_III_speed = branch18.branch("3");
        qTESLA_Rnd1_p_I = branch18.branch(ReportMetadata.ID_TIPS);
        ...
        bc_exch = branch19;
        newHope = branch19.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier branch20 = aSN1ObjectIdentifier.branch(ReportMetadata.ID_TIPS);
        bc_ext = branch20;
        linkedCertificate = branch20.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
    }
}
