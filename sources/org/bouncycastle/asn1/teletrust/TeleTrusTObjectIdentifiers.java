...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        rsaSignatureWithripemd256 = branch.branch(ReportMetadata.ID_TIPS);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("3.2");
        ecSign = branch2;
        ecSignWithSha1 = branch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        ASN1ObjectIdentifier branch5 = branch4.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        versionOne = branch5;
        brainpoolP160r1 = branch5.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        brainpoolP160t1 = branch5.branch("2");
        brainpoolP192r1 = branch5.branch("3");
        brainpoolP192t1 = branch5.branch(ReportMetadata.ID_TIPS);
