...
public class BERPrivate extends ASN1Private {
    public BERPrivate(int i10, ASN1Encodable aSN1Encodable) throws IOException {
        this(true, i10, aSN1Encodable);
    }

    public BERPrivate(int i10, ASN1EncodableVector aSN1EncodableVector) {
        super(true, i10, getEncodedVector(aSN1EncodableVector));
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BERPrivate(boolean z10, int i10, ASN1Encodable aSN1Encodable) throws IOException {
        super(z10 || aSN1Encodable.toASN1Primitive().isConstructed(), i10, getEncoding(z10, aSN1Encodable));
    }

    BERPrivate(boolean z10, int i10, byte[] bArr) {
        super(z10, i10, bArr);
    }
    ...
    public void encode(ASN1OutputStream aSN1OutputStream, boolean z10) throws IOException {
        aSN1OutputStream.writeEncodedIndef(z10, this.isConstructed ? 224 : 192, this.tag, this.octets);
    }
}
