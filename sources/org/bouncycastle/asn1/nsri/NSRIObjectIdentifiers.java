...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_pad_1 = branch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_aria128_ecb = branch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_aria128_cbc = branch2.branch("2");
        id_aria128_cfb = branch2.branch("3");
        id_aria128_ofb = branch2.branch(ReportMetadata.ID_TIPS);
