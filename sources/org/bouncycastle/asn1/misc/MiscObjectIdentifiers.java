...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        netscapeCertType = aSN1ObjectIdentifier.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        netscapeBaseURL = aSN1ObjectIdentifier.branch("2");
        netscapeRevocationURL = aSN1ObjectIdentifier.branch("3");
        netscapeCARevocationURL = aSN1ObjectIdentifier.branch(ReportMetadata.ID_TIPS);
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier5.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
