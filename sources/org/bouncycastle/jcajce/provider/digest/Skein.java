...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i10, int i11) {
            String str = "Skein-MAC-" + i10 + HelpFormatter.DEFAULT_OPT_PREFIX + i11;
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i10 + RemoteSettings.FORWARD_SLASH_STRING + i11, str);
            StringBuilder sb3 = new StringBuilder();
            sb3.append("KeyGenerator.");
            sb3.append(str);
            configurableProvider.addAlgorithm(sb3.toString(), str2 + "$SkeinMacKeyGenerator_" + i10 + JavaConstant.Dynamic.DEFAULT_NAME + i11);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i10 + RemoteSettings.FORWARD_SLASH_STRING + i11, str);
        }
