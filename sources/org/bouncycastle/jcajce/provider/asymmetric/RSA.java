...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider2.addAlgorithm("Cipher", aSN1ObjectIdentifier, "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$PKCS1v1_5Padding");
            ASN1ObjectIdentifier aSN1ObjectIdentifier2 = X509ObjectIdentifiers.id_ea_rsa;
            configurableProvider2.addAlgorithm("Cipher", aSN1ObjectIdentifier2, "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$PKCS1v1_5Padding");
            ...
            configurableProvider2.addAlgorithm("Cipher", aSN1ObjectIdentifier3, "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$OAEPPadding");
            ...
            registerOid(configurableProvider2, aSN1ObjectIdentifier, "RSA", keyFactorySpi);
            registerOid(configurableProvider2, aSN1ObjectIdentifier2, "RSA", keyFactorySpi);
            registerOid(configurableProvider2, aSN1ObjectIdentifier3, "RSA", keyFactorySpi);
            ASN1ObjectIdentifier aSN1ObjectIdentifier4 = PKCSObjectIdentifiers.id_RSASSA_PSS;
            registerOid(configurableProvider2, aSN1ObjectIdentifier4, "RSA", keyFactorySpi);
            registerOidAlgorithmParameters(configurableProvider2, aSN1ObjectIdentifier, "RSA");
            registerOidAlgorithmParameters(configurableProvider2, aSN1ObjectIdentifier2, "RSA");
            registerOidAlgorithmParameters(configurableProvider2, aSN1ObjectIdentifier3, "OAEP");
            registerOidAlgorithmParameters(configurableProvider2, aSN1ObjectIdentifier4, "PSS");
            ...
            configurableProvider2.addAlgorithm("Signature." + aSN1ObjectIdentifier4, "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$PSSwithRSA");
            configurableProvider2.addAlgorithm("Signature.OID." + aSN1ObjectIdentifier4, "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$PSSwithRSA");
            ...
            if (configurableProvider2.hasAlgorithm("MessageDigest", StringUtils.MD5)) {
                addDigestSignature(configurableProvider2, StringUtils.MD5, "org.bouncycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$MD5", PKCSObjectIdentifiers.md5WithRSAEncryption);
                addISO9796Signature(configurableProvider2, StringUtils.MD5, "org.bouncycastle.jcajce.provider.asymmetric.rsa.ISOSignatureSpi$MD5WithRSAEncryption");
            }
            if (configurableProvider2.hasAlgorithm("MessageDigest", "SHA1")) {
                ...
                configurableProvider2.addAlgorithm(sb2.toString(), "SHA1WITHRSA");
                configurableProvider2.addAlgorithm("Alg.Alias.Signature.OID." + aSN1ObjectIdentifier5, "SHA1WITHRSA");
