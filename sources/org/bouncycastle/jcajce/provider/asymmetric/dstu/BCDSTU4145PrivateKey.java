...
public class BCDSTU4145PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f23842d;
    ...
    public BCDSTU4145PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        this.algorithm = str;
        this.f23842d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCDSTU4145PrivateKey(ECPrivateKey eCPrivateKey) {
        this.f23842d = eCPrivateKey.getS();
        this.algorithm = eCPrivateKey.getAlgorithm();
        this.ecSpec = eCPrivateKey.getParams();
    }

    public BCDSTU4145PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.f23842d = eCPrivateKeySpec.getS();
    ...
    public BCDSTU4145PrivateKey(BCDSTU4145PrivateKey bCDSTU4145PrivateKey) {
        this.f23842d = bCDSTU4145PrivateKey.f23842d;
    ...
    public BCDSTU4145PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.f23842d = eCPrivateKeySpec.getD();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:26:0x0180  */
    ...
    private void populateFromPrivKeyInfo(org.bouncycastle.asn1.pkcs.PrivateKeyInfo r13) throws java.io.IOException {
        /*
            r12 = this;
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r0 = r13.getPrivateKeyAlgorithm()
        ...
        L_0x00f0:
            ...
            byte[] r1 = r0.getB()
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r2 = r13.getPrivateKeyAlgorithm()
        ...
        L_0x0144:
            ...
            org.bouncycastle.math.ec.ECPoint r1 = org.bouncycastle.asn1.ua.DSTU4145PointEncoder.decodePoint(r11, r1)
        ...
        L_0x0151:
            ...
            r12.ecSpec = r1
        L_0x0178:
            org.bouncycastle.asn1.ASN1Encodable r13 = r13.parsePrivateKey()
        ...
        L_0x018b:
            ...
            r12.f23842d = r0
            org.bouncycastle.asn1.DERBitString r13 = r13.getPublicKey()
            r12.publicKey = r13
        L_0x019b:
            return
        */
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f23842d, engineGetSpec());
    }
}
