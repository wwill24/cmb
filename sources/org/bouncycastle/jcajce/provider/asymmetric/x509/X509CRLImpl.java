...
abstract class X509CRLImpl extends X509CRL {
    ...
    protected CertificateList f23852c;
    protected boolean isIndirect;
    protected String sigAlgName;
    protected byte[] sigAlgParams;

    X509CRLImpl(JcaJceHelper jcaJceHelper, CertificateList certificateList, String str, byte[] bArr, boolean z10) {
        this.bcHelper = jcaJceHelper;
        this.f23852c = certificateList;
        this.sigAlgName = str;
    ...
    private void checkSignature(PublicKey publicKey, Signature signature, ASN1Encodable aSN1Encodable, byte[] bArr) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException {
        ...
        try {
            ...
            this.f23852c.getTBSCertList().encodeTo(bufferedOutputStream, ASN1Encoding.DER);
    ...
    private void doVerify(PublicKey publicKey, SignatureCreator signatureCreator) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
        ...
        if (this.f23852c.getSignatureAlgorithm().equals(this.f23852c.getTBSCertList().getSignature())) {
            int i10 = 0;
            if ((publicKey instanceof CompositePublicKey) && X509SignatureUtil.isCompositeAlgorithm(this.f23852c.getSignatureAlgorithm())) {
                List<PublicKey> publicKeys = ((CompositePublicKey) publicKey).getPublicKeys();
                ASN1Sequence instance = ASN1Sequence.getInstance(this.f23852c.getSignatureAlgorithm().getParameters());
                ASN1Sequence instance2 = ASN1Sequence.getInstance(DERBitString.getInstance(this.f23852c.getSignature()).getBytes());
                boolean z10 = false;
            ...
            } else if (X509SignatureUtil.isCompositeAlgorithm(this.f23852c.getSignatureAlgorithm())) {
                ASN1Sequence instance4 = ASN1Sequence.getInstance(this.f23852c.getSignatureAlgorithm().getParameters());
                ASN1Sequence instance5 = ASN1Sequence.getInstance(DERBitString.getInstance(this.f23852c.getSignature()).getBytes());
                boolean z11 = false;
    ...
    private Set getExtensionOIDs(boolean z10) {
        ...
        if (getVersion() != 2 || (extensions = this.f23852c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f23852c.getRevokedCertificateEnumeration();
    ...
    public byte[] getExtensionValue(String str) {
        ASN1OctetString extensionValue = getExtensionValue(this.f23852c, str);
        if (extensionValue == null) {
            return null;
        }
        try {
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f23852c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f23852c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        Time nextUpdate = this.f23852c.getNextUpdate();
        if (nextUpdate == null) {
            return null;
        }
    ...
    public String getSigAlgOID() {
        return this.f23852c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f23852c.getSignature().getOctets();
    }

    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f23852c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e10) {
            throw new CRLException(e10.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f23852c.getThisUpdate().getDate();
    }

    public int getVersion() {
        return this.f23852c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f23852c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f23852c.getIssuer();
    ...
    public String toString() {
        ...
        Extensions extensions = this.f23852c.getTBSCertList().getExtensions();
        if (extensions != null) {
            Enumeration oids = extensions.oids();
