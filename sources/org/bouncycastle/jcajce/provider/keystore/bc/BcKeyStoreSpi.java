...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    private class StoreEntry {
        ...
        StoreEntry(String str, Date date2, int i10, Object obj2) {
            new Date();
            this.alias = str;
            this.date = date2;
            this.type = i10;
        ...
        StoreEntry(String str, Date date2, int i10, Object obj2, Certificate[] certificateArr) {
            new Date();
            this.alias = str;
            this.date = date2;
            this.type = i10;
        ...
        public java.lang.Object getObject(char[] r11) throws java.security.NoSuchAlgorithmException, java.security.UnrecoverableKeyException {
            ...
            L_0x000e:
                ...
                org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r3 = org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x00fa }
                ...
                org.bouncycastle.jcajce.io.CipherInputStream r3 = new org.bouncycastle.jcajce.io.CipherInputStream     // Catch:{ Exception -> 0x00fa }
                r3.<init>(r2, r1)     // Catch:{ Exception -> 0x00fa }
                org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r1 = org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x0049 }
            ...
            L_0x0049:
                ...
                org.bouncycastle.jcajce.io.CipherInputStream r4 = new org.bouncycastle.jcajce.io.CipherInputStream     // Catch:{ Exception -> 0x00fa }
                r4.<init>(r2, r3)     // Catch:{ Exception -> 0x00fa }
                org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r2 = org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x0083 }
            ...
            L_0x0083:
                ...
                org.bouncycastle.jcajce.io.CipherInputStream r4 = new org.bouncycastle.jcajce.io.CipherInputStream     // Catch:{ Exception -> 0x00fa }
                r4.<init>(r2, r3)     // Catch:{ Exception -> 0x00fa }
                org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r2 = org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x00fa }
            ...
            L_0x00bb:
                ...
                org.bouncycastle.jcajce.io.CipherOutputStream r3 = new org.bouncycastle.jcajce.io.CipherOutputStream     // Catch:{ Exception -> 0x00fa }
    ...
    /* access modifiers changed from: protected */
    public Cipher makePBECipher(String str, int i10, char[] cArr, byte[] bArr, int i11) throws IOException {
        try {
