...
public class BufferedEncoder {
    ...
    public BufferedEncoder(Translator translator2, int i10) {
    ...
    public int processBytes(byte[] bArr, int i10, int i11, byte[] bArr2, int i12) {
        if (i11 >= 0) {
            ...
            if (i11 > i14) {
                ...
                byte[] bArr4 = this.buf;
                int encode = translator2.encode(bArr4, 0, bArr4.length, bArr2, i12) + 0;
                this.bufOff = 0;
                int i16 = i11 - i14;
                int i17 = i10 + i14;
                int i18 = i12 + encode;
                int length2 = i16 - (i16 % this.buf.length);
                i15 = encode + this.translator.encode(bArr, i17, length2, bArr2, i18);
                i11 = i16 - length2;
                i10 = i17 + length2;
            }
            if (i11 != 0) {
