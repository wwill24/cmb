...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_cp_accredited = branch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("3");
        id_isismtt_at = branch2;
        id_isismtt_at_dateOfCertGen = branch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_isismtt_at_procuration = branch2.branch("2");
        id_isismtt_at_admission = branch2.branch("3");
        id_isismtt_at_monetaryLimit = branch2.branch(ReportMetadata.ID_TIPS);
