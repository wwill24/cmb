...
public interface EACObjectIdentifiers {
    ...
    static {
        ...
        id_PK = branch;
        id_PK_DH = branch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_PK_ECDH = branch.branch("2");
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("2.2.3");
        id_CA = branch2;
        ASN1ObjectIdentifier branch3 = branch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_CA_DH = branch3;
        id_CA_DH_3DES_CBC_CBC = branch3.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier branch4 = branch2.branch("2");
        id_CA_ECDH = branch4;
        id_CA_ECDH_3DES_CBC_CBC = branch4.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ASN1ObjectIdentifier branch5 = aSN1ObjectIdentifier.branch("2.2.2");
        id_TA = branch5;
        ASN1ObjectIdentifier branch6 = branch5.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_TA_RSA = branch6;
        id_TA_RSA_v1_5_SHA_1 = branch6.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_TA_RSA_v1_5_SHA_256 = branch6.branch("2");
        id_TA_RSA_PSS_SHA_1 = branch6.branch("3");
        id_TA_RSA_PSS_SHA_256 = branch6.branch(ReportMetadata.ID_TIPS);
        ...
        id_TA_ECDSA = branch7;
        id_TA_ECDSA_SHA_1 = branch7.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_TA_ECDSA_SHA_224 = branch7.branch("2");
        id_TA_ECDSA_SHA_256 = branch7.branch("3");
        id_TA_ECDSA_SHA_384 = branch7.branch(ReportMetadata.ID_TIPS);
