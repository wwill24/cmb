...
class LMOtsPublicKey implements Encodable {
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMOtsPublicKey getInstance(java.lang.Object r4) throws java.lang.Exception {
        ...
        L_0x002f:
            ...
            org.bouncycastle.pqc.crypto.lms.LMOtsPublicKey r4 = getInstance(r1)     // Catch:{ all -> 0x0048 }
            r1.close()
            return r4
        L_0x0048:
            r4 = move-exception
    ...
    public LMSContext createOtsContext(LMOtsSignature lMOtsSignature) {
        ...
        LmsUtils.u32str(this.f23997q, digest);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f23997q != lMOtsPublicKey.f23997q) {
            return false;
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.parameter.getType()).bytes(this.I).u32str(this.f23997q).bytes(this.K).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.parameter;
        return ((((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.I)) * 31) + this.f23997q) * 31) + Arrays.hashCode(this.K);
    }
}
