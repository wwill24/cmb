...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    public static org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters getInstance(java.lang.Object r11) throws java.io.IOException {
        ...
        L_0x0059:
            ...
            org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters r11 = getInstance(r1)     // Catch:{ all -> 0x0072 }
            r1.close()
            return r11
        L_0x0072:
            r11 = move-exception
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f23991l == hSSPrivateKeyParameters.f23991l && this.isShard == hSSPrivateKeyParameters.isShard && this.indexLimit == hSSPrivateKeyParameters.indexLimit && this.index == hSSPrivateKeyParameters.index && this.keys.equals(hSSPrivateKeyParameters.keys)) {
    ...
    public HSSPrivateKeyParameters extractKeyShard(int i10) {
        ...
        synchronized (this) {
            ...
            if (getUsagesRemaining() >= j10) {
                ...
                makeCopy = makeCopy(new HSSPrivateKeyParameters(this.f23991l, arrayList, arrayList2, j11, j11 + j10, true));
                resetKeyToIndex();
            } else {
    ...
    public LMSContext generateLMSContext() {
        ...
        synchronized (this) {
            ...
            while (i11 < i10) {
                int i12 = i11 + 1;
                lMSSignedPubKeyArr[i11] = new LMSSignedPubKey(sig2.get(i11), keys2.get(i12).getPublicKey());
                i11 = i12;
            }
            incIndex();
        }
    ...
    public synchronized byte[] getEncoded() throws IOException {
        Composer bool;
        bool = Composer.compose().u32str(0).u32str(this.f23991l).u64str(this.index).u64str(this.indexLimit).bool(this.isShard);
    ...
    public synchronized HSSPublicKeyParameters getPublicKey() {
        return new HSSPublicKeyParameters(this.f23991l, getRootKey().getPublicKey());
    }
    ...
    public int hashCode() {
        ...
        long j11 = this.index;
        return (((((((((this.f23991l * 31) + (this.isShard ? 1 : 0)) * 31) + this.keys.hashCode()) * 31) + this.sig.hashCode()) * 31) + ((int) (j10 ^ (j10 >>> 32)))) * 31) + ((int) (j11 ^ (j11 >>> 32)));
    }
    ...
    public void resetKeyToIndex() {
        ...
        L_0x00ff:
            ...
            r4[r9] = r6
            r7 = r4[r10]
            org.bouncycastle.pqc.crypto.lms.LMSPublicKeyParameters r6 = r6.getPublicKey()
            byte[] r6 = r6.toByteArray()
            org.bouncycastle.pqc.crypto.lms.LMSSignature r6 = org.bouncycastle.pqc.crypto.lms.LMS.generateSign(r7, r6)
            r5[r10] = r6
        L_0x012e:
            r6 = 1
            goto L_0x0150
