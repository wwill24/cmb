...
class LMOtsSignature implements Encodable {
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMOtsSignature getInstance(java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0032:
            ...
            org.bouncycastle.pqc.crypto.lms.LMOtsSignature r4 = getInstance(r1)     // Catch:{ all -> 0x004b }
            r1.close()
            return r4
        L_0x004b:
            r4 = move-exception
    ...
    public boolean equals(Object obj) {
        ...
        return Arrays.equals(this.f23998y, lMOtsSignature.f23998y);
    }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.C).bytes(this.f23998y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.C)) * 31) + Arrays.hashCode(this.f23998y);
    }
}
