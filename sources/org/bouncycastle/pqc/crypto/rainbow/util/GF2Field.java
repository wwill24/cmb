...
public class GF2Field {
    ...
    public static short addElem(short s10, short s11) {
        return (short) (s10 ^ s11);
    }

    public static short getExp(short s10) {
        return exps[s10];
    }

    public static short getLog(short s10) {
        return logs[s10];
    }

    public static short invElem(short s10) {
        if (s10 == 0) {
            return 0;
        }
        return exps[255 - logs[s10]];
    }

    public static short multElem(short s10, short s11) {
        if (s10 == 0 || s11 == 0) {
            return 0;
        }
        short[] sArr = exps;
