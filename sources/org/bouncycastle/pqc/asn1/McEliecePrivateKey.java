...
public class McEliecePrivateKey extends ASN1Object {
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f23971n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f23970k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer((long) this.f23971n));
        aSN1EncodableVector.add(new ASN1Integer((long) this.f23970k));
