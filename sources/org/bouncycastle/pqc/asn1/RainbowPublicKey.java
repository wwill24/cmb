...
public class RainbowPublicKey extends ASN1Object {
    ...
    public RainbowPublicKey(int i10, short[][] sArr, short[][] sArr2, short[] sArr3) {
        ...
        this.docLength = new ASN1Integer((long) i10);
    ...
    private RainbowPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        for (int i10 = 0; i10 < instance.size(); i10++) {
            this.coeffQuadratic[i10] = ASN1OctetString.getInstance(instance.getObjectAt(i10)).getOctets();
        }
        ...
        for (int i11 = 0; i11 < aSN1Sequence2.size(); i11++) {
            this.coeffSingular[i11] = ASN1OctetString.getInstance(aSN1Sequence2.getObjectAt(i11)).getOctets();
        }
