...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
    ...
    public LMSPrivateKey extractKeyShard(int i10) {
        ...
        return lMSKeyParameters instanceof LMSPrivateKeyParameters ? new BCLMSPrivateKey((LMSKeyParameters) ((LMSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i10)) : new BCLMSPrivateKey((LMSKeyParameters) ((HSSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i10));
    }
