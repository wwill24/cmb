...
public final class StaticBucketMap implements Map {
    ...
    private class EntrySet extends AbstractSet {
        ...
        public boolean contains(Object obj) {
            ...
            synchronized (StaticBucketMap.this.m_locks[access$800]) {
                for (Node node = StaticBucketMap.this.m_buckets[access$800]; node != null; node = node.next) {
    ...
    private class KeySet extends AbstractSet {
        ...
        public boolean remove(Object obj) {
            ...
            synchronized (StaticBucketMap.this.m_locks[access$800]) {
                Node node = StaticBucketMap.this.m_buckets[access$800];
                while (node != null) {
    ...
    public final int getHash(Object obj) {
        ...
        int i13 = i12 ^ (i12 >>> 6);
        int i14 = i13 + (~(i13 << 11));
        int length = (i14 ^ (i14 >>> 16)) % this.m_buckets.length;
        if (length < 0) {
            return length * -1;
        }
        return length;
    ...
    public final void clear() {
        for (int i10 = 0; i10 < this.m_buckets.length; i10++) {
            Lock lock = this.m_locks[i10];
            synchronized (lock) {
                this.m_buckets[i10] = null;
                lock.size = 0;
            }
        }
    }
    ...
    public boolean containsValue(java.lang.Object r6) {
        /*
            ...
            r1 = r0
        L_0x0002:
            org.apache.commons.collections.StaticBucketMap$Node[] r2 = r5.m_buckets
            int r2 = r2.length
            if (r1 >= r2) goto L_0x002c
            org.apache.commons.collections.StaticBucketMap$Lock[] r2 = r5.m_locks
            r2 = r2[r1]
            monitor-enter(r2)
            org.apache.commons.collections.StaticBucketMap$Node[] r3 = r5.m_buckets     // Catch:{ all -> 0x0029 }
        ...
        L_0x0010:
            ...
            goto L_0x0022
        L_0x001f:
            org.apache.commons.collections.StaticBucketMap$Node r3 = r3.next     // Catch:{ all -> 0x0029 }
            goto L_0x0010
        L_0x0022:
    ...
    public final int hashCode() {
        int i10 = 0;
        for (int i11 = 0; i11 < this.m_buckets.length; i11++) {
            synchronized (this.m_locks[i11]) {
                for (Node node = this.m_buckets[i11]; node != null; node = node.next) {
                    i10 += node.hashCode();
                }
            }
        }
    ...
    public StaticBucketMap(int i10) {
        ...
        for (int i11 = 0; i11 < max; i11++) {
            this.m_locks[i11] = new Lock();
        }
    }

    private void atomic(Runnable runnable, int i10) {
        if (i10 >= this.m_buckets.length) {
            runnable.run();
            return;
        }
        synchronized (this.m_locks[i10]) {
