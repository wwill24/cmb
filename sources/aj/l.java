...
public final class l implements a {
    ...
    private final TextInputLayout f24869a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final TextInputLayout f24870b;

    private l(@NonNull TextInputLayout textInputLayout, @NonNull TextInputLayout textInputLayout2) {
        this.f24869a = textInputLayout;
        this.f24870b = textInputLayout2;
    }
    ...
    public static l d(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(h.pi2_ui_input_text, viewGroup, false);
        if (z10) {
